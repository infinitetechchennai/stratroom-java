...
<td class="text-center text-nowrap"><img width="16" src="${swotImageUrls[item.status]}"></td>
...
$(document).on("click", ".toggle-swot-view", function () {

    const container = $("#contentload");

    const treeView = container.find(".swot-analysis-tree");
    const tableView = container.find(".swot-analysis-table");
