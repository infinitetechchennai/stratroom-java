...
function drop(event) {
  ...
  // Check the number of elements already in #text-body
  var textBody = document.getElementById("text-body");
  var textBody01 = document.getElementById("text-body-01");

  if (textBody.children.length < 2) {
   // Append to #text-body if it has less than 2 items
   appendCardToBody(data, textBody,'g-col-12 g-col-md-6');
 } else {
   // Else append to #text-body-01
   appendCardToBody(data, textBody01,'g-col-12 g-col-md-3');
 }
...
//   Widget Type Chart Start
  ...
  <div class="card map-card border h-100">
    <div class="card-header border-0 bg-transparent pb-0 d-flex gap-2 align-items-center justify-content-between">
      <h5 class="card-title fs-6 mb-0">
        <strong editable="true" contenteditable="true" onkeypress="return (this.innerText.length <= 36)">% Customer
      ...
      <div class="d-flex gap-3">
        ...
        <div class="dropdown">
          <button class="btn btn-link p-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            <img width="18" height="18" src="assets/images/icons/menu-dot-vertical-i.svg">
          </button>
          <ul class="dropdown-menu dropdown-menu-end border-0 shadow" style="">
            ...
            <li>
              <a class="dropdown-item" href="#bubble-large" data-bs-toggle="modal">Enlarge</a>
            </li>
            <li>
  ...
  if (data == "ColumnChart") {
    $("#dashboard-body")
      .append(`<div class="g-col-12 g-col-md-6">
        <div class="card map-card border h-100">
          <div class="card-header border-0 bg-transparent pb-0 d-flex gap-2 align-items-center justify-content-between">
          <h5 class="card-title fs-6 mb-0"><strong
                  editable="true"
            ...
            <div class="date-picker">
              <input
                class="top_datepicker form-control form-control-sm"
                id="datePickerCL" />
            </div>
              
           <div class="dropdown">
  <button class="btn btn-link p-0" type="button" data-bs-toggle="dropdown" aria-expanded="true">
    <img width="18" height="18" src="assets/images/icons/menu-dot-vertical-i.svg">
  </button>
  <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
    ...
    <li>
      <a class="dropdown-item" href="#column-large" data-bs-toggle="modal">Enlarge</a>
    </li>
...
<div class="dropdown">
  ...
  <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
    ...
    <li>
      <a class="dropdown-item" href="#line-large" data-bs-toggle="modal">Enlarge</a>
    </li>
    <li>
      <a class="dropdown-item" href="#" onclick="return false;">Delete</a>
    </li>
    ...
    <div class="card-header border-0 bg-transparent pb-0 d-flex gap-2 align-items-center justify-content-between">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
          ...
          <li>
            <a class="dropdown-item" href="#area-large" data-bs-toggle="modal">Enlarge</a>
          </li>
          <li>
            <a class="dropdown-item" href="#" onclick="return false;">Delete</a>
          </li>
    ...
    <div class="card-header border-0 bg-transparent pb-0 d-flex gap-2 align-items-center justify-content-between">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
          ...
          <li>
            <a class="dropdown-item" href="#pie-large" data-bs-toggle="modal">Enlarge</a>
          </li>
          <li>
            <a class="dropdown-item" href="#" onclick="return false;">Delete</a>
          </li>
    ...
    <div class="card-header border-0 bg-transparent pb-0 d-flex gap-2 align-items-center justify-content-between">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
          ...
          <li>
            <a class="dropdown-item" href="#waterfall-large" data-bs-toggle="modal">Enlarge</a>
          </li>
          <li>
            <a class="dropdown-item" href="#" onclick="return false;">Delete</a>
          </li>
    ...
    <div class="card-header border-0 bg-transparent pb-0 d-flex gap-2 align-items-center justify-content-between">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
          ...
          <li>
            <a class="dropdown-item" href="#Stackedchart-large" data-bs-toggle="modal">Enlarge</a>
          </li>
          <li>
            <a class="dropdown-item" href="#" onclick="return false;">Delete</a>
          </li>
    ...
    <div class="card-header border-0 bg-transparent pb-0 d-flex gap-2 align-items-center justify-content-between">
      ...
      <div class="d-flex gap-3">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
            <li>
              <a class="dropdown-item" href="#drilldown_setting" data-bs-toggle="modal" onclick="return false;">Settings</a>
            </li>
            <li>
              <a class="dropdown-item" href="#drilldown_view" data-bs-toggle="modal" onclick="return false;">View</a>
            </li>
            <li>
...
if (data == "kpidrilldownDragDiv") {
  ...
  <div class="card table-card border h-100">
    ...
    >
      ...
      <tbody>
        ...
        <td><i class="fas fa-flag" style="color:green"></i></td>
          <td id="name"><i class=" fa fa-angle-down" id="fafa" ></i>Sales and Marketing</td>
          <td>28.53425%</td>
          <td>24.53425%</td>
          <td>38.53425%</i></td>
        </tr>
        ...
        <tr class="parent">
          ...
          <td id="name"><i class=" fa fa-angle-down" id="fafa" ></i>Human Resource <br/>and admin</td>
          <td>28.53425%</td>
          <td>24.53425%</td>
          <td>38.53425% </td>
        </tr>
    ...
    $(document).ready(function () {
      $(".kpidrilldownTable").paging({ limit: 5 });
          ...
          <div class="card-header border-0 bg-transparent pb-0 d-flex gap-2 align-items-center justify-content-between">
            ...
            <div class="date-picker">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                  <li>
                    <a class="dropdown-item" href="#kpistatusCountsettingsModal" data-bs-toggle="modal">Settings</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="#kpicount_view" data-bs-toggle="modal">View</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="#" onclick="return false;">Download PDF</a>
                  </li>
  ...
  if (data == "projectstatusCount") {
    ...
    <div class="g-col-12 select-toggle myinitiative sub_initiatives">
      <div class="card table-card border h-100">
        <div class="card-header border-0 bg-transparent pb-0 d-flex gap-2 align-items-center justify-content-between">
          <h5 class="card-title fs-6 mb-0">
            <strong editable="true" contenteditable="true" onkeypress="return (this.innerText.length <= 36)">Project Status
              Count </strong>
          </h5>
          <div class="d-flex gap-3">
            <div class="date-picker ">
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                <li>
                  <a class="dropdown-item" href="#kpistatusCountsettingsModal" data-bs-toggle="modal"
                    onclick="return false;">Settings</a>
                </li>
                <li>
                  <a class="dropdown-item" href="#kpicount_view" data-bs-toggle="modal" onclick="return false;">View</a>
                </li>
                <li>
                  <a class="dropdown-item" href="#" onclick="return false;">Download PDF</a>
                </li>
    ...
    if (data == "riskstatusCount") {
        ...
        if (data == "riskeventdatabase") {
            ...
            $(document).ready(function () {
            $(".riskEventDatabase").paging({ limit: 8 });
            });
            ...
            if (data == "dataDragDiv") {
              ...
              dataRender();
                ...
                if (data == "riskRegDiv") {
                  ...
                  $(document).ready(function () {
                  $(".riskRegisterPageNav").paging({ limit: 7 });
                  });
                  ...
                  dataRender();
                    ...
                    if (data == "ermriskRegDiv") {
                      ...
                      if (data == "riskmonitersreg") {
                        ...
                        $(document).ready(function () {
                        $(".riskMonitersReg").paging({ limit: 7 });
                        });
                                ...
                                if (data == "occurrence") {
                                  ...
                                  if (data == "pb-critical") {
                                    ...
                                    if (data == "drcavailability") {
                                      ...
                                      $(document).ready(function () {
                                      $(".drcAvailability").paging({ limit: 7 });
                                      });
...
function appendCardToBody(data, targetDiv,columnClass) {
   if (data == "normalTextType1") {
     targetDiv.innerHTML += `
       <div class="${columnClass}">
         <div class="card text-start text-card text-card-main border">
           <div class="card-header border-0 bg-transparent pb-0 d-flex align-items-center justify-content-between">
             <div class="text-muted period">Jan 2019 - Dec 2020</div>
             <div class="dropdown">
               <button class="btn btn-link p-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                 <img width="18" height="18" src="assets/images/icons/menu-dot-vertical-i.svg" />
               </button>
               <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                 <li><a class="dropdown-item" href="#text_setting" data-bs-toggle="modal" onclick="return false">Settings</a></li>
           ...
           <div class="card-body">
             <div class="icon p-3">
               <img width="32" height="32" src="assets/images/icons/risk-management-i.svg" alt="risk-management" />
             </div>
             <h4 class="card-title mb-2">Total Revenue</h4>
             <h5 class="amount mb-2">$ 202.35 M</h5>
             <div class="d-flex align-items-center">
               <div class="trend-icon me-2">
                 <img width="14" height="14" src="assets/images/icons/down-i.png" alt="Trend Low" />
               </div>
     ...
     targetDiv.innerHTML += `
       <div class="${columnClass}">
         <div class="card text-start text-card text-card-main border">
           ...
           <div class="card-body">
             <div class="icon p-3">
               <img width="32" height="32" src="assets/images/icons/initiatives-i.svg" alt="initiatives" />
             </div>
             <h4 class="card-title mb-2">Total Revenue</h4>
             <h5 class="amount mb-2">$ 202.35 M</h5>
             <div class="d-flex align-items-center">
     ...
     targetDiv.innerHTML += `
       <div class="${columnClass}">
         <div class="card text-start text-card text-card-main border">
           ...
           <div class="card-body">
             <div class="icon p-3">
               <img width="32" height="32" src="assets/images/icons/kpi-i.svg" alt="kpi" />
             </div>
             <h4 class="card-title mb-2">Total Revenue</h4>
             <h5 class="amount mb-2">$ 202.35 M</h5>
             <div class="d-flex align-items-center">
     ...
     targetDiv.innerHTML += `
       <div class="${columnClass}">
         <div class="card text-start text-card text-card-main border">
           ...
           <div class="card-body">
             <div class="icon p-3">
               <img width="32" height="32" src="assets/images/icons/personal-dashboard-i.svg" alt="Personal Dashboard" />
             </div>
             <h4 class="card-title mb-2">Total Revenue</h4>
             <h5 class="amount mb-2">$ 202.35 M</h5>
             <div class="d-flex align-items-center">
