...
const ScorecardPageContent = ({ pageIdProp }) => {
    ...
    useEffect(() => {
        ...
        const calculatorIds = ['objective-calculator-modal', 'kpi-calculator-modal', 'kpiActual-calculator-modal', 'kpi_formula_popup', 'ytd-calculator-modal', 'prespective-calculator-modal'];
