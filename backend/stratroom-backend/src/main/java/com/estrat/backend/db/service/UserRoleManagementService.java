...
public class UserRoleManagementService {
    ...
    public UserDTO saveUserRole(UserDTO userDTO) {
        ...
        if (roledetails != null && roledetails.getRoleId() != 0L) {
            List<RoleUserMapping> roleUserMappings = this.roleusermappingrepo.findAllByIdEmpId(profilePo);
    ...
    public void updateOwner(EmployeeProfilePo updateProfile) {
        List<EmployeeDepartmentMapping> employeeDepartmentMappingList = this.employeeDepartmentMappingRepository.findByEmpId(updateProfile.getEmpId());
    ...
    public UserDTO updateUserRole(UserDTO userDTO) {
        ...
        if (userDTO.getDeptIds() != null && !userDTO.getDeptIds().isEmpty() || userDTO.getDeptValue() != null && !userDTO.getDeptValue().isEmpty()) {
            ...
            Optional<EmployeeDepartmentMapping> employeeDepartmentMapping;
            ...
            if (userDTO.getDeptValue() != null) {
                ...
                if (userDeptMappingList != null && !userDeptMappingList.isEmpty()) {
                    ...
                    for (UserDeptMapping userDeptMapping2 : userDeptMappingList) {
        ...
        if (userDTO.getRoleId() != null && userDTO.getRoleId() != 0L) {
            ...
            if (roledetails != null) {
                ...
                userRoleManagement.setRoleId(Long.valueOf(((RoleDetailsPo)roledetails).getRoleId()));
            }
        } else {
            roledetails = this.roleRepository.getRoleinfo(userDTO.getOrgId(), 0, userDTO.getUserRole());
            if (roledetails != null && ((List)roledetails).size() > 0 && ((RoleDetailsPo)((List)roledetails).get(0)).getRoleId() != 0L) {
                userRoleManagement.setRoleId(Long.valueOf(((RoleDetailsPo)((List)roledetails).get(0)).getRoleId()));
                userRoleManagement.setRole(((RoleDetailsPo)((List)roledetails).get(0)).getRoleName());
                List<RoleUserMapping> roleUserMappings = this.roleusermappingrepo.findAllByIdEmpId(profilePo);
                if (!roleUserMappings.isEmpty() && roleUserMappings != null) {
                    for (RoleUserMapping roleUserMapping : roleUserMappings) {
                        this.roleusermappingrepo.delete(roleUserMapping);
                ...
                RoleUserMapping roleusermap = new RoleUserMapping(Long.valueOf(((RoleDetailsPo)((List)roledetails).get(0)).getRoleId()), Long.valueOf(profilePo.getEmpId()));
    ...
    public void deleteOwnerMapping(Long id) {
        List<DepartmentChartMapping> departmentChartMappings = this.departmentChartMappingRepository.findOwnerList(id);
    ...
    public void saveUserRoleManagement(Employee employee, String type) {
        ...
        if (!check.isPresent()) {
            ...
            if (userRoleManagement.getEmpId() != employee.getEmpId()) {
                this.userRoleManagementRepository.delete(userRoleManagement);
    ...
    public void updateDeptMapping(Long empId, String departmentId, Long createdBy, String firstName) {
        List<EmployeeDepartmentMapping> employeeDepartmentMappingList = this.employeeDepartmentMappingRepository.findByEmpId(empId.longValue(), "Active");
    ...
    public void updateRole(UserDTO userDTO) {
        ...
        List<RoleUserMapping> roleUserMappings = this.roleusermappingrepo.findAllByIdEmpId(employeeProfilePo);
        if (!roleUserMappings.isEmpty() && roleUserMappings != null) {
            for (RoleUserMapping roleUserMapping : roleUserMappings) {
                this.roleusermappingrepo.delete(roleUserMapping);
            }
    ...
    public void removeRole(Long roleId) {
        List<UserRoleManagement> employeeProfilePo = this.userRoleManagementRepository.findByRoleId(roleId, 0);
