 ...
 *  com.estrat.backend.db.resource.ComplianceDetailsController
...
import com.estrat.backend.db.service.ComplianceDetailsAttachmentService;
import com.estrat.backend.db.service.ComplianceDetailsService;
...
public class ComplianceDetailsController {
    ...
    public ResponseEntity<ComplianceAreaDTO> save(@RequestBody ComplianceAreaDTO complianceAreaDTO, HttpServletRequest request) throws RequestException {
        ...
        return new ResponseEntity(taskDTOObj, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ComplianceAreaDTO> getById(@PathVariable(value="id") Long id) throws RequestException {
        ComplianceAreaDTO riskCauseAndConsequenceDTO = new ComplianceAreaDTO(this.complianceDetailsService.findByAreaId(id.longValue()).get());
    ...
    public ResponseEntity<ComplianceAreaDTO> deleteById(@PathVariable(value="id") Long id, HttpServletRequest request) throws RequestException {
        Optional<ComplianceArea> task = this.complianceDetailsService.findByAreaId(id.longValue());
        if (task.isPresent()) {
            ComplianceArea riskConqObj = task.get();
            List<ComplianceDetails> complainDetail = this.complianceDetailsRepository.findAllByAreaId(id.longValue());
    ...
    public ResponseEntity<ComplianceDetailsDTO> getTaskById(@PathVariable(value="id") Long id) throws RequestException {
        ComplianceDetailsDTO comlainceDTO = new ComplianceDetailsDTO(this.complianceDetailsService.findById(id.longValue()).get());
        this.complianceDetailsService.populateComplainceImpactDesc(comlainceDTO);
        return new ResponseEntity(comlainceDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ComplianceDetailsDTO> deleteTaskById(@PathVariable(value="id") Long id, HttpServletRequest request) throws RequestException {
        Optional<ComplianceDetails> task = this.complianceDetailsService.findById(id.longValue());
        if (task.isPresent()) {
            ComplianceDetails riskConqObj = task.get();
