 ...
 *  com.estrat.backend.scorecard.dto.MissionVisionValueDto
 *  com.estrat.backend.scorecard.service.MissionVisionValueService
 *  com.estrat.backend.scorecard.service.MissionVisionValueService$1
...
import com.estrat.backend.scorecard.dto.MissionVisionValueDto;
import com.estrat.backend.scorecard.service.MissionVisionValueService;
...
public class MissionVisionValueService {
    ...
    public MissionVisionValueDto saveMVV(MissionVisionValueDto missionVisionValueDto) {
        ...
        return (MissionVisionValueDto)this.commonRestTemplate.postForObject(url, (Object)missionVisionValueDto, MissionVisionValueDto.class);
    }

    public MissionVisionValueDto updateMVV(MissionVisionValueDto missionVisionValueDto) {
        String url = this.dbUrl + "/missionVisionValue";
        return (MissionVisionValueDto)this.commonRestTemplate.putForObject(url, (Object)missionVisionValueDto, MissionVisionValueDto.class);
    }
