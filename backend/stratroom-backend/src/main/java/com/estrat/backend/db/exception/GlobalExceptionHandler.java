 ...
 *  com.estrat.backend.db.dto.ErrorDTO
 *  com.estrat.backend.db.exception.AuthorizationException
 *  com.estrat.backend.db.exception.ExceptionLogHelper
 *  com.estrat.backend.db.exception.GlobalExceptionHandler
 ...
 */
package com.estrat.backend.db.exception;

import com.estrat.backend.db.dto.ErrorDTO;
import com.estrat.backend.db.exception.AuthorizationException;
...
@ControllerAdvice
@Component("dbGlobalExceptionHandler")
