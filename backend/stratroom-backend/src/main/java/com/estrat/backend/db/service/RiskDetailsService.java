...
public class RiskDetailsService {
    ...
    public List<RiskDTO> riskListByEmpId(long empId, String dateRange) {
        ...
        long empOrgId = (employee != null && employee.getOrgDetails() != null) ? employee.getOrgDetails().getOrgId() : 0L;
        ControlPanelGeneralDTO controlPanelGeneralDTO = this.generalService.findByOrgId(empOrgId);
