...
import com.estrat.backend.db.dao.MeetingManagementRepository;
...
public class MeetingManagementService {
    ...
    public void delete(MeetingManagement meetingManagement) {
        this.meetingManagementRepository.delete(meetingManagement);
    }
    ...
    public List<MeetingManagementDTO> findAll(long empId) {
        List<MeetingManagement> dbList = this.meetingManagementRepository.findAllByEmpId(Long.valueOf(empId), 0);
    ...
    public List<MeetingManagementDTO> findAll(long empId, String pageId, String dateRange) {
        List<MeetingManagement> dbList = null;
    ...
    public void saveSetDate() {
        List<MeetingManagement> dbList = this.meetingManagementRepository.findAll();
        Date firstDate = null;
        Date secondDate = null;
