 ...
 *  com.estrat.backend.auth.dto.ErrorDTO
 *  com.estrat.backend.auth.exception.AuthorizationException
 *  com.estrat.backend.auth.exception.ExceptionLogHelper
 *  com.estrat.backend.auth.exception.GlobalExceptionHandler
 *  com.estrat.backend.auth.exception.RequestException
 *  com.estrat.backend.auth.exception.RestServiceClientException
...
import com.estrat.backend.auth.dto.ErrorDTO;
import com.estrat.backend.auth.exception.AuthorizationException;
import com.estrat.backend.auth.exception.ExceptionLogHelper;
