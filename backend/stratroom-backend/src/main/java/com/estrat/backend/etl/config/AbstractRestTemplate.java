 ...
 *  com.estrat.backend.etl.config.AbstractRestTemplate
 *  com.estrat.backend.etl.config.AbstractRestTemplate$HttpComponentsClientHttpRequestWithBodyFactory
...
import com.estrat.backend.etl.config.AbstractRestTemplate;
