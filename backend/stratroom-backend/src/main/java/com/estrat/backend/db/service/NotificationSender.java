 ...
 *  com.estrat.backend.db.service.NotificationSender
...
public class NotificationSender {
    ...
    public void processNotifications() {
        List<NotificationEntity> notifications = this.notificationRepository.findBySentFalse();
        notifications.forEach(this::sendAndMarkNotification);
