...
@Entity
@Table(name="employee_pages_link", schema="orgstructure")
public class EmployeePagesLinkDetails {
    @Id
    ...
    public EmployeePagesLinkDetails() {
    }

    public EmployeePagesLinkDetails(PageLinkDTO pagesLinkDetails) {
