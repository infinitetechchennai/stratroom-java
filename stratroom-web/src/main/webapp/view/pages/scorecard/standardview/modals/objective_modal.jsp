	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content modal-content-setscrollheight">
			<div class="modal-header">
				<h6 class="modal-title" id="myLargeModalLabel"  data-i18n="Objective Description">Objective Description</h6>
				...
				<form id="objectiveForm" style="display:none">
					<div class="form-row">
						<div class="form-group col-md-3" id="objective_id_wrapper" style="display:none">
							<label for="objective_id" data-i18n="ID">ID</label> <input type="text"
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="objective_description"  data-i18n="Description">Description</label>
					...
					<div class="form-row">
						<div class="form-group browser-default col-md-6">
							<label for="objective_owner" data-i18n="Owner">Owner</label> <select
								id="objective_owner" name="objective_owner" class="form-control browser-default" style="display: block !important;">
							</select>
						</div>
						<div class="form-group col-md-6">
							<label for="kpi_start_end_date" data-i18n="Start/End Date">Start and End Date</label> 
					...
					<div class="form-row">
						...
						<div class="form-group col-md-4">
							<label for="objective_start_end_date" data-i18n="Status">Status</label> <select
				...
				<div
					...
					<div class="d-flex flex-row">
						<div class="d-flex flex-column">
							<p>
								<span  data-i18n="Created By :">Created By : </span><span id="objCreatedBy"></span>
							</p>
							<p>
								<span  data-i18n="Created Date :">Created Date : </span><span id="objCreatedByDate"></span>
							</p>
						</div>
						<div class="d-flex flex-column pl-5">
							<p>
								<span  data-i18n="Modified By :">Modified By : </span><span id="objUpdatedBy"></span>
							</p>
							<p>
								<span data-i18n="Modified Date :">Modified Date : </span><span id="objUpdatedByDate"></span>
							</p>
						</div>
					</div>
				</div>
...
<div class="modal custom-modal fade kpi_setting objective_description_popup" id="objective-add-modal"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
						...
						<div class="grid gap-3">
							...
							<div class="g-col-12">
								<div class="form-group">
									<label for="objective_name" data-i18n="Name" data-translate="page.scorecard.scorecardItems.name">Name</label> <input type="text"
										class="form-control browser-default" name="objective_name" id="objective_name"
										placeholder="" autocomplete="off">
								</div>
							</div>
							<div class="g-col-12">
								<div class="form-group">
									<label for="objective_description" data-i18n="Description" data-translate="page.scorecard.scorecardItems.description">Description</label>
									<textarea class="form-control browser-default" name="objective_description"
										id="objective_description" placeholder="" cols="" rows="6"
										autocomplete="off"></textarea>
								</div>
							</div>
							<div class="g-col-12 g-col-md-6">
								<div class="form-group">
									<label for="objective_owner" data-i18n="Owner" data-translate="page.scorecard.scorecardItems.owner">Owner</label> <select
										id="objective_owner" name="objective_owner" class="form-control browser-default"
							...
							<div class="g-col-12 g-col-md-6">
								<div class="form-group">
									<label for="kpi_start_end_date" data-i18n="Start/End Date" data-translate="page.scorecard.scorecardItems.startEndDate">Start and End
										Date</label>
									<input type="text" name="objective_start_end_date" id="objective_start_end_date"
										class="form-control browser-default date_pickers" data-range="true"
										data-multiple-dates-separator=" - " data-language="en" autocomplete="off" />
								</div>
							</div>
							<div class="g-col-12">
								<div class="form-group">
									<label for="custom_objective" class="form-label" data-translate="page.scorecard.scorecardItems.performance">Performance</label>
									<div class="input-group">
										<input type="text" class="form-control browser-default" id="custom_objective"
											name="custom_objective" placeholder="Performance" aria-label="Performance"
                                        ...
                                        onclick='handleCustomThresholdEvent("OBJECTIVE")' data-translate="page.scorecard.scorecardItems.kpiCalculator">
											Calculator
										</button>
									</div>
								</div>
							...
							<div class="g-col-12 g-col-md-4">
								<div class="form-group">
									<label for="objective_weight" data-i18n="Weight(%)" data-translate="page.scorecard.scorecardItems.weight">Weight(%)</label>
									<input type="text" class="form-control browser-default" name="objectiveweight"
										id="objectiveweight" autocomplete="off">
								</div>
							</div>
							<div class="g-col-12 g-col-md-4">
								<div class="form-group">
							...
							<div class="g-col-12 g-col-md-4">
								<div class="form-group">
									<label for="objective_start_end_date" data-i18n="Status" data-translate="page.scorecard.scorecardItems.status">Status</label> <select
										id="objective_status" name="" class="form-control browser-default">
										<option value="0" data-i18n="Choose">Choose</option>
										<option value="Manual" data-i18n="Manual">Manual</option>
										<option value="Weighted" data-i18n="Weighted">Weighted</option>
                ...
                <button class="btn btn-primary" value="Save">Save -->
						...
						<button type="button" class="btn btn-label-secondary btn-default1 btn" data-dismiss="modal"
							aria-label="Close" data-i18n="Cancel" data-translate="page.scorecard.scorecardItems.cancel">Cancel</button>
						<button class="btn btn-primary scorecard_save_btn" value="Save" data-i18n="Save" data-translate="page.scorecard.scorecardItems.save">Save</button>
						</button>
