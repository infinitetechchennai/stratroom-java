                                ...
                                <div class="form-row mt-2">
                                    ...
                                    <ul class="d-flex flex-row flex-wrap ml-2">
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <div class="form-check">
                                                    <label class="form-check-label" data-i18n="Risk">
                                                        <input class="form-check-input" type="checkbox" value="">
                                                        Risk
                                                        <span class="form-check-sign">
                                                            <span class="check"></span>
                            ...
                            <form id="kpiForm">
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-4">
                                      ...
                                      <a href="#" class="kpi_trigger" data-toggle="modal" data-target=".kpi_formula_popup"></a>
                                  </div>
                    ...
                    <div class="m-t--50">
                        ...
                        <div aria-label="breadcrumb m-b-10">
                            <ol class="breadcrumb mb_bcrumb">
                                <li class="breadcrumb-item"><a href="#" data-i18n="Scorecard">Scorecard</a></li>
