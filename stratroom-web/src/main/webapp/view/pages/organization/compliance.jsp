...
;
  ...
  <body class="light">
    ...
    <main class="pt-2 pb-2">
            ...
            <div class="page-header grid gap-2 pb-1">
                <div class="g-col-8 d-flex align-items-center">
                    <h4 class="title">
                        ...
                        <span data-translate="title">Compliance Management</span>
                    </h4>
                            ...
                            <li>
                             ...
                             <li>
                              ...
                              <li>
                                ...
                                <a href="#" id="popoverFilterComplianceArea">
                                <span type="button" class="icon" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Compliance Area">                                    
        ...
        <div class="container-lg py-2">
           <div id="complianceManagement">
                    <div class="card custom-card table-card">
                        <div class="card-header">
                            <div class="c-header-left">                              
                                <h5 class="card-title">                 
                                <strong editable="true" contenteditable="true"
                                onkeypress="return (this.innerText.length <= 36)" data-translate="title">Compliance Management</strong>
                                </h5>
                            </div>
                  ...
                  <span data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Add">
                    <i class="fas fa-plus"></i>
                        ...
                        <div class="card-body">
                            <table class="table table-sm border w-100" id="table-compliance" style="--stratroom-border-color:rgba(var(--stratroom-black-rgb),0.04)">
                                <thead class="text-center align-middle"></thead>
                                <tbody></tbody>
                            </table>
                        </div>
                    </div>
	...
	<button class="btn btn-primary" value="Save" onclick="return createdeptEmployee()">Save</button>
			  ...
			  <div class="card custom-card delete-card border-0">
				<div class="card-body">
				  ...
				  <div class="btn-wrap">
					...
					<button class="btn btn-sm btn-danger rounded-pill" value="" onclick="handleComplianceDelete()">Delete</button>
				  </div>
				</div>
				</div>
			  </div>
	  ...
	  <!--  delete modal :::::::::::::::::::::::::::::::::::::::: -->
	   ...
	   <div class="modal custom-modal custom-delete-modal fade" id="delete-parent-modal" data-backdrop="static"
		data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel_1" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" style="--stratroom-modal-width:320px">
		  <div class="modal-content">
			<div class="modal-body">
			  <div class="card custom-card delete-card border-0">
				<div class="card-body">
				  ...
				  <div class="btn-wrap">
					...
					<button class="btn btn-sm btn-danger rounded-pill" value="" onclick="handleComplianceParentDelete()">Delete</button>
				  </div>
				</div>
				</div>
			  </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen-sm-down modal-lg modal-lg-600">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myLargeModalLabel_1" data-translate="Compliance Description">Compliance Description</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="card custom-card border-0">
          <div class="modal-body">
            <div class="grid gap-3">
                  ...
                  <input type="hidden" class="form-control" name="controlID" id="complianceId" 
                    placeholder="Control ID">

				  <input type="hidden" class="form-control" name="controlIdValue" id="controlIdValue" 
                    placeholder="Control ID">

					<input type="hidden" class="form-control" name="ownerids" id="ownerids" 
                    placeholder="Control ID">
               
              <div class="g-col-12 g-col-md-4">

                <div class="form-group">
                  <label for="controlID-add" class="form-label" data-translate="Control ID">Control ID</label>
                  <input type="text" class="form-control" name="controlID" id="controlId" disabled
                    placeholder="Control ID">
                </div>
			  ...
			  <!-- <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="auditFindings-add" class="form-label" data-translate="Audit Findings">Name</label>
                  <input type="text" class="form-control" name="auditFindings" id="controller-name"
                    placeholder="" />
                </div>
              </div> -->
              <div class="g-col-12 g-col-md-12">
                <div class="form-group">
                  <label for="controlDescription-add" class="form-label" data-translate="Control Description">Control Description</label>
                  <textarea class="form-control" autocomplete="off" name="controlDescription" id="controlDescription-add" cols=""
                    rows="3" placeholder="Control Description"></textarea>
                </div>
              </div>
              <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="complianceArea-add" class="form-label" data-translate="Compliance Area">Compliance Area</label>
					<select id="complianceArea-add" name="complianceArea" class="form-select selectdrop-add-compliance" aria-invalid="false" data-placeholder="Select Compliance Area">
						<option value="" selected disabled>Select Compliance Area</option>
						<option value="data_protection_privacy">Data Protection & Privacy</option>
              ...
              <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="applicableRegulation-add" class="form-label" data-translate="Applicable Regulation">Applicable Regulation</label>
                  <select id="applicableRegulation-add" name="applicableRegulation[]"  class="form-select selectdrop-add-compliance">
                  </select>
                </div>
              </div>
              ...
              <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="riskLevel-add" class="form-label" data-translate="Risk Level">Risk Level</label>
                  
                  <select id="riskLevel-add" name="riskLevel" class="form-select selectdrop-add-compliance" aria-invalid="false" data-placeholder="Select Priority">
               ...
               <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="controlType-add" class="form-label" data-translate="Control Type">Control Type</label>
                  <select id="controlType-add" name="controlType" class="form-select selectdrop-add-compliance" aria-invalid="false" data-placeholder="Select Priority">
                    <option value="" selected disabled>Select Control Type</option>
              ...
              <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="implementationStatus-add" class="form-label" data-translate="Implementation Status">Implementation Status</label>
                  <select id="implementationStatus-add" name="implementationStatus" class="form-select selectdrop-add-compliance" aria-invalid="false" data-placeholder="Select Implementation Status">
                    <option value="" selected disabled>Select Implementation Status</option>
               ...
               <!-- <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="implementationStatus-add" class="form-label">Implementation Status</label>
                  <input type="text" class="form-control" name="implementationStatus" id="implementationStatus-add"
               ...
               <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="lastAssessmentDate-add" class="form-label" data-translate="Last Assessment Date">Last Assessment Date</label>
                  <input type="text" class="form-control datePicker" placeholder="Last Assessment Date" name="lastAssessmentDate"
                    data-language="en" autocomplete="off" id="lastAssessmentDate-add">
                </div>
              </div>

              <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="nextReviewDate-add" class="form-label" data-translate="Next Review Date">Next Review Date</label>
                  <input type="text" class="form-control datePicker" placeholder="Next Review Date" name="nextReviewDate"
                    data-language="en" autocomplete="off" id="nextReviewDate-add">
                </div>
              </div>
              ...
              <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  ...
                  <select id="taskStatus-add" name="taskStatus-add" class="form-select selectdrop-add-compliance" aria-invalid="false" data-placeholder="Select Status">
               ...
               <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="auditRequired-add" class="form-label" data-translate="Audit Required">Audit Required</label>
                  <select id="auditRequired-add" name="auditRequired-add" class="form-select selectdrop-add-compliance" aria-invalid="false" data-placeholder="Select Audit Required">
                    <option value="" selected disabled>Select Audit Required</option>
              ...
              <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="lastAuditDate-add" class="form-label" data-translate="Last Audit Date">Last Audit Date</label>
                  <input type="text" class="form-control datePicker" placeholder="Last Audit Date" name="lastAuditDate"
                    data-language="en" autocomplete="off" id="lastAuditDate-add">
                </div>
              </div>
              <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="auditFindings-add" class="form-label" data-translate="Audit Findings">Audit Findings</label>
                  <input type="text" class="form-control" name="auditFindings" id="auditFindings-add"
               ...
               <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="correctiveActions-add" class="form-label" data-translate="Corrective Actions">Corrective Actions</label>
                  <input type="text" class="form-control" name="correctiveActions" id="correctiveActions-add"
               ...
               <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="actionDueDate-add" class="form-label" data-translate="Action Due Date">Action Due Date</label>
                  <input type="text" class="form-control datePicker" placeholder="Action Due Date" name="actionDueDate"
                    data-language="en" autocomplete="off" id="actionDueDate-add">
                </div>
              </div>

              <div class="g-col-12 g-col-md-6">
                <div class="form-group">
                  <label for="evidenceFileReference-add" class="form-label" data-translate="Evidence File Reference">Evidence File Reference</label>
                  <input type="file" class="form-control file-input" name="evidenceFileReference" id="evidenceFileReference-add"
               ...
               <div class="g-col-12">
                <div class="form-group">
                  <label for="notes-add" class="form-label" data-translate="Notes">Notes</label>
                  <textarea type="text" class="form-control" name="notes" id="notes-add"
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary" value="Save" data-translate="Save" onclick="handleComplianceSave()">Save</button>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen-sm-down">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close usersClickAdd" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
...
<link href="assets/css/flatpickr.min.css" rel="stylesheet">
	...
	<script src="${contextroot}/js/compliance.js"></script>
...
$(document).ready(function () {
  // Map compliance areas to regulations
  const regulationMap = {
    data_protection_privacy: ["GDPR", "CCPA", "HIPAA", "ISO 27701"],
    cybersecurity: ["NIST CSF", "ISO 27032", "SOC 2", "PCI-DSS"],
    financial_reporting: ["SOX", "IFRS", "GAAP"],
    information_security: ["ISO 27001", "NIST CSF", "COBIT", "CIS Controls"]
  };

  // Initialize Select2
  $('#applicableRegulation-add').select2({
    width: '100%',
    dropdownParent: $('#task-add-modal')
  });

  // Handle compliance area change
  $('#complianceArea-add').on('change', function () {
    const selectedArea = $(this).val();
    const regulations = regulationMap[selectedArea] || [];

    // Clear current options
    const $regulationSelect = $('#applicableRegulation-add');
    $regulationSelect.empty();

    // Append new options
    regulations.forEach(reg => {
      const value = reg.toLowerCase().replace(/\s+/g, '_');
      $regulationSelect.append(new Option(reg, value));
    });

    // Refresh Select2 dropdown
    $regulationSelect.trigger('change.select2');
  });
});
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".selectdrop-add-compliance").select2({
                // allowClear: true,
                width: "100%",
                dropdownParent: $('#task-add-modal')
            });
