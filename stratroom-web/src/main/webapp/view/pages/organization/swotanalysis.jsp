...
<input type="hidden" id="userrolename" value="${principal.profile.userRoleName}">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="form-group col-md-2" style="padding-left: 4px;">
							<button type="button" id="attachementupload" class="btn custom-form-control btn-custom-primary">Upload</button>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="card cardBox">
						...
						<div class="row text-center"
							...
							<div class="col-md-12 card-footer">
								...
								</a> <a href="#" data-toggle="modal" data-target="#uploaded_files"
									class="card-footer-icon"> <i class="fas fa-paperclip"
									data-toggle="tooltip" data-placement="bottom"
									title="Attachment"></i>
								</a>
							</div>
	...
	<script>
	$('.swot_add_multiuser_popup,#addpeople,#recommendation,#addpeopleactions').modal({
		show : false,
		backdrop : 'static',
		keyboard : false
	});
	...
	$.fn.select2.amd.define("SearchableSingleSelection", [
		...
		*/
        ...
        $('#swot_strength_Form #strength_impact').select2({
