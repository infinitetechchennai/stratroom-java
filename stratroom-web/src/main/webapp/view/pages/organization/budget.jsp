                ...
                <div class="load-page page-actions g-col-4">
                    <div class="page-icons">
                        <ul>
                            <li>
								<a>
									 <span class="icon" data-toggle="modal" data-target="#budget_view">
...
<div class="modal fade upLoadBudgetSuccessModal"  role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg">
		...
		<!--  Budget modal :::::::::::::::::::::::::::::::::::::::: -->
			<div class="modal custom-modal fade" id="budget_view" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel_1"
aria-hidden="true">

    <div class="modal-dialog modal-dialog-centered modal-xl"
        style="max-width:95% !important; width:95% !important; margin:0 auto;">

        <div class="modal-content" style="height:90vh; display:flex; flex-direction:column;">

            <!-- HEADER -->
            <div class="modal-header" style="flex-shrink:0;">
                <h4 class="modal-title">Budget View</h4>
                <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
            </div>

            <!-- BODY (Scrollable) -->
            <div class="modal-body"
                style="overflow-y:auto; overflow-x:hidden; height:100%; padding:10px;">
                 <div class="load-page page-actions g-col-4">
 
                  <div class="form-group" >
                        <select id="department_selectdw" class="form-select form-select-sm" style="width: 100%;">
                ...
                <div class="container-lg py-2" style="padding:10px;">
                    <div class="card custom-card table-card" style="width:100%;">
                        ...
                        <!-- CARD BODY -->
                        <div class="card-body" style="margin-left:10px; overflow-x:auto;">

                            <table id="budgetTableView" class="table table-sm table-bordered"
                                style="width:100%; min-width:2600px; border:1px solid #ccc;">

                                <thead>
                                    <tr class="text-center">
                                        <th rowspan="2" class="align-middle">SI.No</th>
                                        <th style="background:#f7c5d0;">Year</th>
                                        <th style="background:#d7cde8;">Month</th>
                                        <th style="background:#b6e0e0;">Version</th>
                                        <th style="background:#fcd5b5;">GL Account</th>
                                        <th style="background:#f8b5a4;">GL Name</th>
                                        <th style="background:#aedeC0;">Budget Type</th>
                                        <th style="background:#e5b6c9;">Project / Initiative</th>
                                        <th style="background:#fde39b;">Outcome</th>
                                        <th style="background:#c5dedd;">Objective</th>
                                        <th style="background:#ffe0ac;">Sub Initiative</th>
                                        <th style="background:#ffcfd2;">Activity</th>
                                        <th style="background:#e2f0cb;">Sub Activity</th>
                                        <th style="background:#c3d6f3;">Currency</th>
                                        <th style="background:#e5d4ed;">No of Days/Qty</th>
                                        <th style="background:#ffdab9;">Unit Amount</th>
                                        <th style="background:#d0e6a5;">Total Budget</th>
                                        <th style="background:#e0c3fc;">Department</th>
                                        <th style="background:#b5ead7;">Employee</th>
                                        <th style="background:#fff1c1;">Notes</th>
...
<link href="assets/css/pickr.min.css" rel="stylesheet">
    ...
    <!-- <link href="assets/css/select2.min.css" rel="stylesheet" />
    <script src="${contextroot}/js/select2.min.js"></script> -->
    <script src="${contextroot}/js/budgetnew.js"></script>
