...
/* KPI DrillDown Settings */
#kpidrillScorecard + .select2-container {
    width: 104.5% !important;
  }
#kpidrillkpi + .select2-container {
  width: 104.5% !important;
}
#kpidrillstatus + .select2-container {
  width: 104.5% !important;
}

/* KPI Status Count Settings */
#kpistatusScorecard + .select2-container {
  width: 104.5% !important;
}
#kpistatusFrequency + .select2-container {
  width: 104.5% !important;
}

/* Project Status Count Settings */
#projectstatusinitiatives + .select2-container {
  width: 104.5% !important;
}

/* Initiative Progress Count Settings */
#initiativeprogressinitiatives + .select2-container {
  width: 104.5% !important;
}

/* Initiative Blank Report Settings  */
#initiativenoprogressinitiatives + .select2-container {
  width: 104.5% !important;
}
...
<!-- Risk Register Setting -->
   <div class="modal fade" id="riskreg_setting" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel_1"
        ...
        <div class="modal-content">
          ...
          <form id="review_register_Form">
            <div class="row">
              ...
              <div class="form-group col-md-12 mt-2">
                <label for="kpi_fields" data-i18n="Select Fields">Select Fields</label>
                <ul class="d-flex flex-row flex-wrap ml-2">
					<li>
						<div class="form-check">
						  <div class="form-check">
                    ...
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
						  ...
						  Changes in The Target Completion Time
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                        </label>
        ...
        <div class="modal-content">
          ...
          <form id="ermRiskReg_Form">
            <div class="row">
             ...
             <div class="form-group col-md-12 mt-2">
    <label class="form-label" data-i18n="Select Fields">Select Fields</label>
    ...
    <div class="row g-3 mt-1">
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermRiskStatus">
                <label class="form-check-label" for="ermRiskStatus">Risk Status</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermdepartmentName">
                <label class="form-check-label" for="ermdepartmentName">Department Name</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermRiskId">
                <label class="form-check-label" for="ermRiskId">Risk ID</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermRiskName">
                <label class="form-check-label" for="ermRiskName">Risk Name</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermKpi">
                <label class="form-check-label" for="ermKpi">KPI</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermPos">
                <label class="form-check-label" for="ermPos">POS</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermIso">
                <label class="form-check-label" for="ermIso">ISO</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermInfoAsset">
                <label class="form-check-label" for="ermInfoAsset">Information Asset</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermOthers">
                <label class="form-check-label" for="ermOthers">Others</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermInherentScore">
                <label class="form-check-label" for="ermInherentScore">Inherent Score</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermResidualRiskScore">
                <label class="form-check-label" for="ermResidualRiskScore">Residual Risk Score</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermRiskLevel">
                <label class="form-check-label" for="ermRiskLevel">Risk Level</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermMitigation">
                <label class="form-check-label" for="ermMitigation">Mitigation Plan</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermPersonIncharge">
                <label class="form-check-label" for="ermPersonIncharge">Person in Charge</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermTarget">
                <label class="form-check-label" for="ermTarget">Target Completion Time</label>
            </div>
        </div>
        ...
        <div class="col-auto">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ermTargetChanges">
                <label class="form-check-label" for="ermTargetChanges">Changes in Target Completion Time</label>
            </div>
        </div>
                ...
                <ul class="d-flex flex-row flex-wrap ml-2">
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="departmentNamerikevent"/>
                        Department Name
                        <span class="form-check-sign">
                        <span class="check"></span>
                        </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventDate"/>
						  Date of Risk Event
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventRiskReg"/>
                         Risk Register
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventRisk"/>
                          Risk Event
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventType"/>
						  Type of Event
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventIncidentCategory"/>
						Cause of Incident Category
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                        </label>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventIncidentDescription"/>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventLossCategory"/>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventLossDescription"/>
						  Impact Loss Description
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                        </label>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventImactLevel"/>
						  Impact Loss Impact Level
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                        </label>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventCorrection"/>
						  Correction Action
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventMitigation"/>
						  Risk Mitigation
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="eventInventor"/>
						  Inventor/Reporter
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                ...
                <ul class="d-flex flex-row flex-wrap ml-2">
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="deptPos"/>
                        Department Name
                        <span class="form-check-sign">
                        <span class="check"></span>
                        </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posProductServices"/>
						  Product/Services
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posProcess"/>
						  Process (POS)
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posSubProcess"/>
                          Sub Process 
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posClassification"/>
						  Classification
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posTimeStart"/>
						  Working Time Start
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posTimeEnd"/>
						  Working Time End
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posAmountService"/>
                          Amount Service
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posFrequency"/>
						  Frequency
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posTechnology"/>
						  Technology
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posInputs"/>
						  Inputs(vital Record)
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posInternal"/>
						  People-Internal
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posExternal"/>
						  People-External
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posOutput"/>
						  Output(vital Record)
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posFinalMao"/>
						  Final MAO
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
				  ...
				  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posStrategies"/>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="posRto"/>
						                    RTO
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
              ...
              <ul class="d-flex flex-row flex-wrap ml-2">
                <li>
                  <div class="form-check">
                    <div class="form-check">
                    <label class="form-check-label">
                      <input class="form-check-input" type="checkbox" id="deptPosTrading"/>
                      Department Name
                      <span class="form-check-sign">
                      <span class="check"></span>
                      </span>
                ...
                <li>
                  <div class="form-check">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="posTradingClassification"/>
            Classification
                        <span class="form-check-sign">
                          <span class="check"></span>
                        </span>
                ...
                <li>
                  <div class="form-check">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="posTimeCrtical"/>
           Time Crtical
                        <span class="form-check-sign">
                          <span class="check"></span>
                        </span>
                ...
                <li>
                  <div class="form-check">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="posTradingAmountService"/>
                        Amount Service
                        <span class="form-check-sign">
                          <span class="check"></span>
                        </span>
          ...
          <form id="report_template_Form">
            <div class="card custom-card border-0">
				...
				<input type="hidden" id="reporttabletypeField" value="" />
                                ...
                                <div class="g-col-12">
                                    <div class="form-group">
                                        <label for="kpi_fields" class="form-label">Select Fields</label>
                                        <div>
                                            <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" type="checkbox" data-col="0" id="deptRepTemplate" checked>
          <label class="form-check-label">Department Name</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportStraoutcomes"  type="checkbox" data-col="1" checked>
          <label class="form-check-label">Strategic Outcomes</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportStraobjectives" type="checkbox" data-col="2" checked>
          <label class="form-check-label">Strategic Objectives</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportCoherentActions" type="checkbox" data-col="3" checked>
          <label class="form-check-label">Coherent Actions</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportSubActions" type="checkbox" data-col="4" checked>
          <label class="form-check-label">Sub-Actions</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportOutput" type="checkbox" data-col="5" checked>
          <label class="form-check-label">Output</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportResponsibile" type="checkbox" data-col="6" checked>
          <label class="form-check-label">Responsible</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportTarget" type="checkbox" data-col="7" checked>
          <label class="form-check-label">Target Period 2024/25</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportPlanImp" type="checkbox" data-col="8" checked>
          <label class="form-check-label">Planned Implementation Months</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportActualImp" type="checkbox" data-col="9" checked>
          <label class="form-check-label">Actual Implementation Months</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportTempPerformanceStatus" type="checkbox" data-col="10" checked>
          <label class="form-check-label">Performance Status (30 Sept 2024)</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportImpRemarks" type="checkbox" data-col="11" checked>
          <label class="form-check-label">Implementation Remarks</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="reportPeformanceAnalysis" type="checkbox" data-col="12" checked>
          <label class="form-check-label">Performance Analysis Observations Recommendations</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="consolidatereportImpRemarks" type="checkbox" data-col="13" checked>
          <label class="form-check-label">Consolidated Implementation Remarks</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input column-toggle" id="consolidatereportPeformanceAnalysis" type="checkbox" data-col="14" checked>
          <label class="form-check-label">Consolidated Performance Analysis Observations Recommendations</label>
        </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <ul class="d-flex flex-row flex-wrap ml-2">
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="initiativedeptname"/>
                            Department Name
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="initiativename"  data-i18n="Name"/>
                          Name
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="initiativeimpact"/>
                          Impact
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="initiativeplanstartend"/>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="initiativeactualstartend"/>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="initiativeprogress"/>
                          Progress
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                    ...
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label" data-i18n="Target">
                          <input class="form-check-input" type="checkbox" value="" id="initiativetarget"/>
                          Target
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="initiativestatus"/>
                          Status
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="initiativetotal"/>
                          Total
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label" data-i18n="Utilised">
                          <input class="form-check-input" type="checkbox" value="" id="initiativeutilised"/>
                          Utilised
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="initiativebalance"/>
                          Balance
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                ...
                <ul class="d-flex flex-row flex-wrap ml-2">
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="assetbudget"/>
                          Total Asset Budget
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="assetrealization"/>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="assetrealizationpercent"/>
						  Total Asset Realization %
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="totalliabilitiesasset"/>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="totalliabilitiesrealization"/>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="totalliabilitiesrealizationpercent"/>
                          Total Liabilities Realization %
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="totalbudget"/>
                          Total Budget
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="totalrealization"/>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="totalrealizationpercent"/>
                          Total Budget Realization %
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
		  ...
		  <ul class="d-flex flex-row flex-wrap ml-2">
			<li>
			  <div class="form-check">
				<div class="form-check">
				  <label class="form-check-label">
					<input class="form-check-input" type="checkbox" value="" id="orgassetbudget"/>
					Total Asset Budget
					<span class="form-check-sign">
					  <span class="check"></span>
					</span>
			...
			<li>
			  <div class="form-check">
				<div class="form-check">
				  <label class="form-check-label">
					<input class="form-check-input" type="checkbox" value="" id="orgassetrealization"/>
					Total Asset Realization
					<span class="form-check-sign">
					  <span class="check"></span>
					</span>
			...
			<li>
			  <div class="form-check">
				<div class="form-check">
				  <label class="form-check-label">
					<input class="form-check-input" type="checkbox" value="" id="orgassetrealizationpercent"/>
					Total Asset Realization %
					<span class="form-check-sign">
					  <span class="check"></span>
					</span>
			...
			<li>
			  <div class="form-check">
				<div class="form-check">
				  <label class="form-check-label">
					<input class="form-check-input" type="checkbox" value="" id="orgtotalliabilitiesasset"/>
					Total Liabilities Budget
					<span class="form-check-sign">
					  <span class="check"></span>
					</span>
			...
			<li>
			  <div class="form-check">
				<div class="form-check">
				  <label class="form-check-label">
					<input class="form-check-input" type="checkbox" value="" id="orgtotalliabilitiesrealization"/>
					Total Liabilities Realization
					<span class="form-check-sign">
					  <span class="check"></span>
					</span>
			...
			<li>
			  <div class="form-check">
				<div class="form-check">
				  <label class="form-check-label">
					<input class="form-check-input" type="checkbox" value="" id="orgtotalliabilitiesrealizationpercent"/>
					Total Liabilities Realization %
					<span class="form-check-sign">
					  <span class="check"></span>
					</span>
			...
			<li>
			  <div class="form-check">
				<div class="form-check">
				  <label class="form-check-label">
					<input class="form-check-input" type="checkbox" value="" id="orgtotalbudget"/>
					Total Budget
					<span class="form-check-sign">
					  <span class="check"></span>
					</span>
			...
			<li>
			  <div class="form-check">
				<div class="form-check">
				  <label class="form-check-label">
					<input class="form-check-input" type="checkbox" value="" id="orgtotalrealization"/>
					Total Budget Realization
					<span class="form-check-sign">
					  <span class="check"></span>
					</span>
			...
			<li>
			  <div class="form-check">
				<div class="form-check">
				  <label class="form-check-label">
					<input class="form-check-input" type="checkbox" value="" id="orgtotalrealizationpercent"/>
					Total Budget Realization %
					<span class="form-check-sign">
					  <span class="check"></span>
					</span>
              ...
              <div class="form-group col-md-12 mt-2">
                ...
                <ul class="d-flex flex-row flex-wrap ml-2">
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label" data-i18n='Actual'>
                          <input class="form-check-input" type="checkbox" value="" id="kpiactual"/>
                          Actual
                          <span class="form-check-sign" >
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label"  data-i18n='Target'>
                          <input class="form-check-input" type="checkbox" value="" id="kpitarget"/>
                          Target
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="kpiytd"/>
                          YTD
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="" id="kpigap"/>
                          Gap
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                  ...
                  <li>
                    <div class="form-check">
                      <div class="form-check">
                        <label class="form-check-label" data-i18n="Index">
                          <input class="form-check-input" type="checkbox" value="" id="kpiscore"/>
                          Index
                          <span class="form-check-sign">
                            <span class="check"></span>
                          </span>
                    ...
                    <div class="widget widget-1 chart-type-1">
                        <div class="grid g-2 chart-w-card">
                            ...
                            <span class="icon" data-bs-toggle="tooltip" data-bs-title="Radial">
                              ...
                              <span class="icon" data-bs-toggle="tooltip" data-bs-title="Gantt">
                                <img width="28" height="28" ondragstart="dragStart(event)" draggable="true"
                                    id="GanttChart" src="images/widgets/gantt-i.svg" alt="Gantt Chart" />
                            </span>

                             <span class="icon" data-bs-toggle="tooltip" data-bs-title="Heat Map">
                                <img width="28" height="28" ondragstart="dragStart(event)" draggable="true"
                                    id="HeatMap" src="images/widgets/heatmap-i.svg" alt="HeatMap" />
                            </span>
...
<script>
  $(document).ready(function () {
      ...
      $(".riskEventFilter").on("select2:select", function () {
          var selectedValues = $(this).val();
          if (selectedValues.includes("All")) {
              $("li.select2-results__option").find("input:checkbox").prop("checked", true);
              $(this).val(riskevent_all).trigger("change");
          }
          $(this).select2("close");
      });
      ...
      $(".riskEventFilter").on("select2:unselect", function () {
          var selectedValues = $(this).val();
          if (!selectedValues || !selectedValues.includes("All")) {
              $("li.select2-results__option #riskEventInput").prop("checked", false);
          }
      });
      ...
      function formatRiskeventResult(state) {
          ...
          var id = 'riskEventFilter' + state.id;
          var isAll = state.id === "All";
          var checkbox = $(
              '<div class="checkbox">' +
              '<input class="' + id + '" type="checkbox" ' + (state.selected ? 'checked' : '') + '>' +
          ...
          if (isAll) {
              checkbox.find('input').addClass('#riskEventInput');
          }
          return checkbox;
      }
      $(".riskEventFilter").trigger("change");
  });
</script>
