...
(function () {
  ...
  (u = (function () {
    function t() {}
    return (
      (t.patchCurrentLocale = function (t) {
        return moment.locale(moment.locale(), t);
      }),
      (t.setFirstDayOfTheWeek = function (t) {
        var e;
        if (
          ((t = ((t % 7) + 7) % 7), moment.localeData().firstDayOfWeek() !== t)
        )
          return (
            (e = t - moment.localeData().firstDayOfWeek()),
            this.patchCurrentLocale({
              week: {
                dow: t,
      ...
      (t.tz = function (t) {
        var e, n;
        return (
          (e = Array.prototype.slice.call(arguments, 0, -1)),
          (n = arguments[arguments.length - 1]),
          moment.tz
            ? moment.tz.apply(null, e.concat([n]))
            : n && "utc" == n.toLowerCase()
            ? moment.utc.apply(null, e)
            : moment.apply(null, e)
        );
      }),
      t
    ...
    (c = (function () {
      ...
      return (
        (t.array = function (t, e, n) {
          var a, r, i, o, s;
          for (
            r = new this(t, n), s = [], a = i = 0, o = e - 1;
            0 <= o ? i <= o : i >= o;
            a = 0 <= o ? ++i : --i
          )
            s.push(r.next());
        ...
        (t.prototype.next = function () {
          ...
          return (
            (t = this.date),
            (this.date = t.clone().add(1, this.period)),
            t.clone()
          );
        }),
        t
    ...
    (e = (function () {
      function t() {}
      return (
        (t.rotateArray = function (t, e) {
          return (e %= t.length), t.slice(e).concat(t.slice(0, e));
        }),
        (t.uniqArray = function (t) {
          var e, n, a, r;
          for (r = [], n = 0, a = t.length; n < a; n++)
            (e = t[n]), r.indexOf(e) == -1 && r.push(e);
          return r;
        }),
        t
      );
    ...
    ($.fn.daterangepicker = function (t, e) {
      return (
        ...
        this.each(function () {
          var n;
          if (((n = $(this)), !n.data("daterangepicker")))
            return (
              (t.anchorElement = n),
              e && (t.callback = e),
              (t.callback = $.proxy(t.callback, this)),
              n.data("daterangepicker", new s(t))
            );
        }),
        this
      );
    ...
    (ko.bindingHandlers.daterangepicker = (function () {
      return $.extend(this, {
        ...
        init: function (t, e, n) {
          ...
          return (
            (a = e()),
            (r = ko.unwrap(n.get(this._optionsKey)) || {}),
            $(t).daterangepicker(r, function (t, e, n) {
              return a([t, e]);
            })
          );
        },
        update: function (t, e, n) {
          ...
          return (
            ...
            (c = s[0]),
            (i = s[1]),
            (r = ko.unwrap(n.get(this._formatKey)) || "MMM D, YYYY"),
            (u = moment(c).format(r)),
            (o = moment(i).format(r)),
            ko.ignoreDependencies(function () {
              var t;
              return (
                a.data("daterangepicker").standalone() ||
                  ((t = a.data("daterangepicker").single() ? u : u + " – " + o),
                  a.val(t).text(t)),
                a.data("daterangepicker").startDate(c),
                a.data("daterangepicker").endDate(i)
              );
            })
          );
        },
    ...
    (d = (function () {
      function t() {}
      return (
        (t.allPeriods = ["day", "week", "month", "quarter", "year"]),
        (t.scale = function (t) {
        ...
        (t.extendObservable = function (e) {
          return (
            this.methods.forEach(function (n) {
              return (e[n] = function () {
                return t[n](e());
              });
            }),
    ...
    (r = (function () {
      function e(t) {
        null == t && (t = {}),
          (this.firstDayOfWeek = this._firstDayOfWeek(t.firstDayOfWeek)),
          (this.timeZone = this._timeZone(t.timeZone)),
          (this.periods = this._periods(t.periods)),
          (this.customPeriodRanges = this._customPeriodRanges(
            t.customPeriodRanges
          )),
          (this.period = this._period(t.period)),
          (this.single = this._single(t.single)),
          (this.opened = this._opened(t.opened)),
          (this.expanded = this._expanded(t.expanded)),
          (this.standalone = this._standalone(t.standalone)),
          (this.hideWeekdays = this._hideWeekdays(t.hideWeekdays)),
          (this.locale = this._locale(t.locale)),
          (this.orientation = this._orientation(t.orientation)),
          (this.forceUpdate = t.forceUpdate),
          (this.minDate = this._minDate(t.minDate)),
          (this.maxDate = this._maxDate(t.maxDate)),
          (this.startDate = this._startDate(t.startDate)),
          (this.endDate = this._endDate(t.endDate)),
          (this.ranges = this._ranges(t.ranges)),
          (this.isCustomPeriodRangeActive = ko.observable(!1)),
          (this.anchorElement = this._anchorElement(t.anchorElement)),
          (this.parentElement = this._parentElement(t.parentElement)),
          (this.callback = this._callback(t.callback)),
          this.firstDayOfWeek.subscribe(function (t) {
      ...
      return (
        (e.prototype.extend = function (t) {
          ...
          for (e in n)
            (r = n[e]),
              this.hasOwnProperty(e) && "_" !== e[0] && a.push((t[e] = r));
          return a;
        }),
        ...
        (e.prototype._minDate = function (t) {
          var e, n;
          return (
            t instanceof Array && ((n = t), (t = n[0]), (e = n[1])),
            t || (t = moment().subtract(30, "years")),
            this._dateObservable(t, e)
          );
        }),
        (e.prototype._maxDate = function (t) {
          ...
          return (
            t instanceof Array && ((n = t), (t = n[0]), (e = n[1])),
            t || (t = moment()),
            this._dateObservable(t, e, this.minDate)
          );
        }),
        (e.prototype._startDate = function (t) {
          return (
            t || (t = moment().subtract(29, "days")),
            this._dateObservable(t, null, this.minDate, this.maxDate)
          );
        }),
        (e.prototype._endDate = function (t) {
          return (
            t || (t = moment()),
            this._dateObservable(t, null, this.startDate, this.maxDate)
          );
        }),
        (e.prototype._ranges = function (e) {
          var n, a, r;
          if ((e || (e = this._defaultRanges()), !$.isPlainObject(e)))
            throw new Error(
              "Invalid ranges parameter (should be a plain object)"
            );
          n = [];
          for (a in e)
            switch ((r = e[a])) {
              case "all-time":
                n.push(
                  new t(a, this.minDate().clone(), this.maxDate().clone())
                );
                break;
              case "custom":
                n.push(new i(a));
        ...
        (e.prototype.parseRange = function (t, e) {
          ...
          if (
            ((a = u.tz(r, this.timeZone())),
            (i = u.tz(n, this.timeZone())),
            !a.isValid())
          )
        ...
        (e.prototype._dateObservable = function (t, e, n, a) {
          ...
          return (
            ...
            (r.isWithinBoundaries = (function (t) {
              return function (e) {
                var r, i, o, s, c, d, l;
                return (
                  (e = u.tz(e, t.timeZone())),
                  (s = n()),
                  (i = a()),
                  (r = e.isBetween(s, i, t.period())),
                  (l = e.isSame(s, t.period())),
                  (d = e.isSame(i, t.period())),
                  (c = "exclusive" == n.mode),
                  (o = "exclusive" == a.mode),
                  r || (!c && l && !(o && d)) || (!o && d && !(c && l))
                );
    ...
    (n = (function () {
      function t(t) {
        (this.clickNextButton = p(this.clickNextButton, this)),
          (this.clickPrevButton = p(this.clickPrevButton, this)),
          (this.currentDate = t.currentDate),
          (this.period = t.period),
          (this.timeZone = t.timeZone),
          (this.firstDate = t.firstDate),
          (this.firstYearOfDecade = t.firstYearOfDecade),
          (this.prevDate = ko.pureComputed(
            (function (t) {
              return function () {
                var e, n, a;
                return (
                  (a = t.period.nextPageArguments()),
                  (e = a[0]),
                  (n = a[1]),
                  t.currentDate().clone().subtract(e, n)
                );
              };
            })(this)
          )),
          ...
          (this.selectedMonth = ko.computed({
            ...
            write: (function (t) {
              return function (e) {
                var n;
                if (
                  ((n = t.currentDate().clone().month(e)),
                  !n.isSame(t.currentDate(), "month"))
                )
                  return t.currentDate(n);
              };
            })(this),
            pure: !0,
          })),
          (this.selectedYear = ko.computed({
            ...
            write: (function (t) {
              return function (e) {
                var n;
                if (
                  ((n = t.currentDate().clone().year(e)),
                  !n.isSame(t.currentDate(), "year"))
                )
                  return t.currentDate(n);
              };
            })(this),
          ...
          (this.selectedDecade = ko.computed({
            ...
            write: (function (t) {
              return function (e) {
                var n, a, r;
                if (
                  ((r = (t.currentDate().year() - t.selectedDecade()) % 9),
                  (a = e + r),
                  (n = t.currentDate().clone().year(a)),
                  !n.isSame(t.currentDate(), "year"))
                )
                  return t.currentDate(n);
              };
      ...
      return (
        (t.prototype.clickPrevButton = function () {
        ...
        (t.prototype.prevArrowCss = function () {
          var t, e;
          return (
            (t = this.firstDate().clone().subtract(1, "millisecond")),
            ("day" !== (e = this.period()) && "week" !== e) ||
              (t = t.endOf("month")),
            {
        ...
        (t.prototype.nextArrowCss = function () {
          var t, e, n, a, r;
          return (
            (n = this.period.dimentions()),
            (t = n[0]),
            (r = n[1]),
            (e = this.firstDate()
              .clone()
              .add(t * r, this.period())),
            ("day" !== (a = this.period()) && "week" !== a) ||
              (e = e.startOf("month")),
            {
        ...
        (t.prototype.monthOptions = function () {
          ...
          return (
            ...
            function () {
              n = [];
              for (var a = e; e <= t ? a <= t : a >= t; e <= t ? a++ : a--)
                n.push(a);
              return n;
            }.apply(this)
          );
        ...
        (t.prototype.yearOptions = function () {
          ...
          return function () {
            e = [];
            for (
              var n = (t = this.currentDate.minBoundary().year()),
                a = this.currentDate.maxBoundary().year();
              t <= a ? n <= a : n >= a;
              t <= a ? n++ : n--
            )
              e.push(n);
            ...
            this.yearOptions().map(
              (function (t) {
                return function (e) {
                  var n;
                  return (
                    (n = u.tz([e], t.timeZone())), t.firstYearOfDecade(n).year()
                  );
                };
              })(this)
            )
    ...
    (a = (function () {
      function t(t, e, a) {
        (this.cssForDate = p(this.cssForDate, this)),
          (this.eventsForDate = p(this.eventsForDate, this)),
          (this.formatDateTemplate = p(this.formatDateTemplate, this)),
          (this.tableValues = p(this.tableValues, this)),
          (this.inRange = p(this.inRange, this)),
          (this.period = t.period),
          ...
          (this.isCustomPeriodRangeActive = t.isCustomPeriodRangeActive),
          (this.type = a),
          (this.label = t.locale[a + "Label"] || ""),
          ...
          (this.inputDate = ko.computed({
            read: (function (t) {
              return function () {
                return (t.hoverDate() || t.activeDate()).format(
                  t.locale.inputFormat
                );
              };
            })(this),
            write: (function (t) {
          ...
          (this.firstDate = ko.pureComputed(
            (function (t) {
              return function () {
                var e, n;
                switch (
                  ((e = t.currentDate().clone().startOf(t.period.scale())),
                  t.period())
                ) {
                  case "day":
                  case "week":
          ...
          (this.headerView = new n(this));
      }
      return (
        (t.prototype.calendar = function () {
          var t, e, n, a, r, i, o, s, u, d;
          for (
            i = this.period.dimentions(),
              e = i[0],
              d = i[1],
              a = new c(this.firstDate(), this.period()),
              s = [],
              u = r = 1,
              o = d;
            1 <= o ? r <= o : r >= o;
            ...
            s.push(
              function () {
                ...
                for (
                  ...
                  (n = a.next()),
                    "end" == this.type
                      ? o.push(n.endOf(this.period()))
                      : o.push(n.startOf(this.period()));
                return o;
              }.call(this)
            );
          return s;
        ...
        (t.prototype.inRange = function (t) {
          return (
            (t.isAfter(this.startDate(), this.period()) &&
              t.isBefore(this.endDate(), this.period())) ||
            t.isSame(this.startDate(), this.period()) ||
            t.isSame(this.endDate(), this.period())
          );
        }),
        (t.prototype.tableValues = function (t) {
          ...
          switch (((e = this.period.format()), this.period())) {
            ...
            case "quarter":
              return (
                (a = t.format(e)),
                (t = t.clone().startOf("quarter")),
                (n = c.array(t, 3, "month").map(function (t) {
                  return t.format("MMM");
                })),
                [
                  {
        ...
        (t.prototype.eventsForDate = function (t) {
          return {
            ...
            mouseenter: (function (e) {
              return function () {
                if (e.activeDate.isWithinBoundaries(t))
                  return e.hoverDate(e.activeDate.fit(t));
              };
            })(this),
        ...
        (t.prototype.cssForDate = function (t, e) {
          var n, a, r, i, o;
          return (
            (i = t.isSame(this.activeDate(), this.period())),
            (o = this.activeDate.isWithinBoundaries(t)),
            e || (e = "day" == this.period()),
            (n = !t.isSame(this.currentDate(), "month")),
            (a = this.inRange(t)),
            (r = {
              "in-range": !this.single() && (a || i),
            }),
            (r[this.type + "-date"] = i),
            (r.clickable = o && !this.isCustomPeriodRangeActive()),
        ...
        (t.prototype.firstYearOfDecade = function (t) {
          var e, n, a, r;
          return (
            (e = u.tz(moment(), this.timeZone()).year()),
            (n = e - 4),
            (a = Math.floor((t.year() - n) / 9)),
            (r = n + 9 * a),
            u.tz([r], this.timeZone())
          );
        }),
        t
      );
    ...
    (s = (function () {
      function t(t) {
        var e, n, i, o;
        null == t && (t = {}),
          (this.outsideClick = p(this.outsideClick, this)),
          (this.setCustomPeriodRange = p(this.setCustomPeriodRange, this)),
          (this.setDateRange = p(this.setDateRange, this)),
          new r(t).extend(this),
          (this.startCalendar = new a(this, this.startDate, "start")),
          (this.endCalendar = new a(this, this.endDate, "end")),
          ...
          this.startDate.subscribe(
            (function (t) {
              return function (e) {
                return t.single()
                  ? (t.endDate(e.clone().endOf(t.period())),
                    t.updateDateRange(),
                    t.close())
                  : (t.endDate().isSame(e) &&
                      t.endDate(t.endDate().clone().endOf(t.period())),
                    t.standalone() ? t.updateDateRange() : void 0);
              };
            })(this)
          ),
          ...
          this.callback &&
              ...
              (function (t) {
                return function (e) {
                  ...
                  return (
                    (a = e[0]),
                    (n = e[1]),
                    t.callback(a.clone(), n.clone(), t.period())
                  );
                };
              })(this)
            ),
            this.forceUpdate &&
              ...
              (i = n[0]),
              (e = n[1]),
              this.callback(i.clone(), e.clone(), this.period()))),
          this.anchorElement &&
            ((o = $('<div data-bind="stopBinding: true"></div>').appendTo(
              this.parentElement
            )),
            (this.containerElement = $(this.constructor.template).appendTo(o)),
          ...
          this.opened() && this.updatePosition();
      }
      return (
        (t.prototype.periodProxy = d),
        (t.prototype.calendars = function () {
          return this.single()
            ? [this.startCalendar]
            : [this.startCalendar, this.endCalendar];
        }),
        ...
        (t.prototype.cssClasses = function () {
          ...
          for (
            ...
            (a = r[t]), (n[a + "-period"] = a == this.period());
          return n;
        }),
        ...
        (t.prototype.isActiveDateRange = function (t) {
          ...
          if (t.constructor == i) {
            for (r = this.ranges, n = 0, a = r.length; n < a; n++)
              if (
                ((e = r[n]), e.constructor !== i && this.isActiveDateRange(e))
              )
                return !1;
            return !0;
          }
          return (
            this.startDate().isSame(t.startDate, "day") &&
            this.endDate().isSame(t.endDate, "day")
          );
        }),
        ...
        (t.prototype.setPeriod = function (t) {
          return (
            this.isCustomPeriodRangeActive(!1),
            this.period(t),
            this.expanded(!0)
          );
        }),
        ...
        (t.prototype.applyChanges = function () {
          this.close(), this.updateDateRange();
          // location.reload(); 
        }),
        ...
        (t.prototype.updatePosition = function () {
          ...
          if (!this.standalone()) {
            switch (
              ...
              (e = $(window).width()),
              this.parentElement.is("body") ||
                ((t = {
                  top:
                    this.parentElement.offset().top -
              ...
              case "left":
                this.containerElement.offset().left < 0
                  ? (n.left = "9px")
                  : (n.right =
                      e -
              ...
              default:
                ...
                $(window).width()
                  ? (n.right = "0")
                  : (n.left = this.anchorElement.offset().left - t.left + "px");
            }
            return this.style(n);
          }
        }),
        (t.prototype.outsideClick = function (t) {
          ...
          if (
            ...
            !(
              "focusin" == t.type ||
              e.closest(this.anchorElement).length ||
              e.closest(this.containerElement).length ||
              e.closest(".calendar").length
            ))
          )
            return this.close();
        }),
