...
public class PerformanceContractDTO {
    ...
    private EmployeeDocumentsDTO employeeDocuments;
    ...
    public EmployeeDocumentsDTO getEmployeeDocuments() {
        return this.employeeDocuments;
    }

    public void setEmployeeDocuments(EmployeeDocumentsDTO employeeDocuments) {
