...
public class Employee {
    ...
    public String formatImageName() {
        if (StringUtils.isNotEmpty((CharSequence)this.lastName) && StringUtils.isNotEmpty((CharSequence)this.firstName)) {
            StringBuffer buffer = new StringBuffer();
            buffer.append(this.firstName.substring(0, 1));
            buffer.append(this.lastName.substring(0, 1));
            return buffer.toString();
        }
        if (StringUtils.isNotEmpty((CharSequence)this.firstName)) {
            return this.firstName;
        }
        if (StringUtils.isNotEmpty((CharSequence)this.lastName)) {
            return this.lastName;
        }
        return "";
    }
