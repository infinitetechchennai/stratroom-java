...
(function(factory) {
    ...
    var OrgChart = function(elem, opts) {
        ...
        this.defaultOptions = {
            ...
            'nodeKPI': 'kpi',
            'nodeImage': 'image',
            'nodeDeptImage': 'deptImage',
            'nodeId': 'id',
            'nodeDeptId': 'deptId',
            'nodeDeptParentId':'deptParentId',
            'nodedeptName':'deptName',
            'nodedeptowner':'owner',
            'nodedownerName':'ownerName',
    ...
    OrgChart.prototype = {
        ...
        dropHandler: function(event) {
        	...
        	if (window.confirm('Are you sure you want to drop this node?')) {
                var $dropZone = $(event.delegateTarget);
                
                var $dragged = this.$chart.data('dragged');
                var dragNodeValue = $dragged.data('nodeData').id;
                var dropNodeValue = $dropZone.data('nodeData').id;
                
                var deptdragnode	=	$dragged.data('nodeData').deptId;
                var deptparentdragnode	=	$dropZone.data('nodeData').deptId;
                ...
                var callorgurl	=	"updateParentEmpId/"+dragNodeValue+"?parentEmpId="+dropNodeValue;
                var methodorgtype	=	"GET";
                if((deptdragnode !== deptparentdragnode) && (deptdragnode !=	undefined && deptdragnode !=	"" && deptdragnode != null) && (deptparentdragnode !=	undefined && deptparentdragnode !=	"" && deptparentdragnode != null)){
                	callorgurl	=	"updateDepartmentParentId/"+deptdragnode+"?deptParentId="+deptparentdragnode;
                	methodorgtype	=	"put";
                }
                ...
                $.ajax({
    				...
    				success : function(data) {
    					if(data.messageFlag	==	null || data.messageFlag == ""){
    						alert("selected node has been moved");
    					}else{
    						alert("You can't assign parant node to child node");
    						location.reload();
    					}
    				}
    			}); 
        ...
        createNode: function(data) {
        	...
        	var editIcon	=	"";
        	var deleteIcon	=	"";
        	var scoreCardLandingUrl = "";
        	var initiativeLandingUrl = "";
        	var kpiLandingUrl = "";
        	var appraisalUrl = "";
        	var riskUrl = "";
        	var orgbottomboxlink	=	false;
            
        	if(data.canMaintain){
        		orgbottomboxlink	=	true;
        		canMaintain = '<a href="#" onclick="return false;" class=" dropdown-toggle js-add_org_struct-sidebar" data-close="true"><img src="images/awsomefont_add.png" width="15" alt=""></a></div><div class="orgiz_edit"><a href="#"><img src="images/awsomefont_edit.png" width="15" alt=""></a></div><div class="orgiz_delete"><a href="#"><img src="images/awsomefont_delete.png" width="15" alt=""></a>';
        	
	        	if(scorecardlinkEnable	==	true){
		        	if(data.scoreCardLandingUrl != "" && data.scoreCardLandingUrl != undefined){
		        		scoreCardLandingUrl = "<div class='orgiz_scorecard_btn'><a href="+data.scoreCardLandingUrl+"><button class='button orgiz_btn_scorecard green_color' name='scorecard' ><span>S</span></button> </a></div>";
		        	}else{
		        		scoreCardLandingUrl = "<div class='orgiz_scorecard_btn orgiz_scorecard_btn_no_link'><a onClick='return false;' href='#'><button class='button orgiz_btn_scorecard green_color' name='scorecard' ><span>S</span></button> </a></div>";
		        	//	scoreCardLandingUrl = "<div class='orgiz_scorecard_btn'><a data-toggle='modal' data-target='.nolinkmodal' title='No Link avaiable' href='#'><button class='button orgiz_btn_scorecard green_color' name='scorecard' ><span>S</span></button> </a></div>";
		        	}
		        	
		        	if(data.kpiLandingUrl != "" && data.kpiLandingUrl != undefined){
		        		kpiLandingUrl = "<div class='orgiz_kpi_btn'><a href="+data.kpiLandingUrl+"><button data-srcval="+data.kpiLandingUrl+" class='button orgiz_btn_kpi orange_color' name='kpi name' ><span>K</span></button> </a></div>";
		        	}else{
		        	kpiLandingUrl = "<div class='orgiz_kpi_btn orgiz_kpi_btn_no_link'><a onClick='return false;' href='#'><button class='button orgiz_btn_kpi orange_color' name='kpi name' ><span>K</span></button> </a></div>";
		        		//kpiLandingUrl = "<div class='orgiz_kpi_btn'><a data-toggle='modal' data-target='.nolinkmodal' title='No Link avaiable' href='#'><button class='button orgiz_btn_kpi orange_color' name='kpi name' ><span>K</span></button> </a></div>";
		        	}
		        }
	        	if(initiativelinkEnable	==	true){
		        	if(data.initiativeLandingUrl != "" && data.initiativeLandingUrl != undefined){
		        		initiativeLandingUrl = "<div class='orgiz_initiative_btn'><a href="+data.initiativeLandingUrl+"><button class='button orgiz_btn_init yellow_color' name='initiative' ><span>I</span></button> </a></div>";
		        	}else{
		        		initiativeLandingUrl = "<div class='orgiz_initiative_btn orgiz_initiative_btn_no_link'><a onClick='return false;' href='#'><button class='button orgiz_btn_init yellow_color' name='initiative' ><span>I</span></button> </a></div>";
		        		//initiativeLandingUrl = "<div class='orgiz_initiative_btn'><a data-toggle='modal' data-target='.nolinkmodal' title='No Link avaiable' href='#'><button class='button orgiz_btn_init yellow_color' name='initiative' ><span>I</span></button> </a></div>";
		        	}
		        }
	        	if(risklinkEnable	==	true){
		        	if(data.riskLandingUrl != "" && data.riskLandingUrl != undefined){
		        		riskUrl = "<div class='orgiz_risk_btn'><a href="+data.riskLandingUrl+"><button class='button orgiz_btn_risk green_color' name='risk' ><span>R</span></button> </a></div>";
		        	}else{
		        		riskUrl = "<div class='orgiz_risk_btn orgiz_risk_btn_no_link'><a onClick='return false;' href='#'><button class='button orgiz_btn_risk green_color' name='risk' ><span>R</span></button> </a></div>";
		        	}
		        }
        		...
        		if(scorecardlinkEnable	==	true){
		        	scoreCardLandingUrl = "<div class='orgiz_scorecard_btn' onClick='return false;'><a onClick='return false;' href='#'><button class='button orgiz_btn_scorecard green_color' name='scorecard' ><span>S</span></button> </a></div>";
		        	kpiLandingUrl = "<div class='orgiz_kpi_btn' onClick='return false;'><a onClick='return false;' href='#'><button class='button orgiz_btn_kpi orange_color' name='kpi name' ><span>K</span></button> </a></div>";
		        }
		        if(initiativelinkEnable	==	true){
		        	initiativeLandingUrl = "<div class='orgiz_initiative_btn' onClick='return false;'><a onClick='return false;' href='#'><button class='button orgiz_btn_init yellow_color' name='initiative' ><span>I</span></button> </a></div>";
		        }
		        if(risklinkEnable	==	true){
		        	riskUrl = "<div class='orgiz_risk_btn' onClick='return false;'><a onClick='return false;' href='#'><button class='button orgiz_btn_risk green_color' name='risk' ><span>R</span></button> </a></div>";
		        }
        	}
            ...
            console.log(this, opts, "thisoptions");
            ...
            if(data.canMaintain){
            	if(createpermission	==	true){
            		addIcon	=	'<div class="orgiz_add" data-deptId="'+data[opts.nodeDeptId]+'"><a href="#" onclick="return false;" class=" dropdown-toggle js-add_org_struct-sidebar" data-close="true"><img src="images/awsomefont_add.png" width="15" alt=""></a></div>';
            	}
            	if(editpermission	==	true){
            		editIcon	=	'<div class="orgiz_edit" data-nodeId="'+data[opts.nodeDeptId]+'" data-deptId="'+data[opts.nodeDeptParentId]+'"><a href="#"><img src="images/awsomefont_edit.png" width="15" alt=""></a></div>';
            	}
            	if(deletepermission	==	true){
            		deleteIcon	=	'<div class="orgiz_delete" data-nodeId="'+data[opts.nodeDeptId]+'"><a href="#"><img src="images/awsomefont_delete.png" width="15" alt=""></a></div>';
            	}
        		canMaintain = addIcon+editIcon+deleteIcon;
        	}
            ...
            if (opts.nodeTemplate) {
                ...
                var image = 'images/media.png';
                
                image = '';
                if (data[opts.nodeImage] !=	undefined) {
                    image = data[opts.nodeImage];
                }
                
                if (data[opts.nodeDeptImage] !=	undefined) {
                    image = data[opts.nodeDeptImage];
                }
                ...
                if(data.deptImage !=	"" && data.deptImage !=	undefined ){
                	image = data.deptImage;	
                }
                
                // $nodeDiv.append('<div class="title">' + data[opts.nodeTitle] + '</div>')
                // .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content">' + (data[opts.nodeContent] || '') + '</div>' : '');
//                $nodeDiv.append(typeof opts.nodeContent !== 'undefined' ? '<div class=""><div class="orgiz_add">'+canMaintain+'</div><div class="d-flex flex-row org_box_top"><div class="flex-column"><img class="rounded-circle orgiz_image" src="' + image + '" width="25" alt="user"></div><div class="flex-column org_box_top_content"><input type="hidden" class="org_id" value="' + data[opts.nodeId] + '" /><div class="orgiz_name">' + data[opts.nodeName] + '</div><div class="orgiz_title">' + data[opts.nodeTitle] + '</div><div class="orgiz_department">' + data[opts.nodeDept] + '</div><div class="orgiz_kpi_name">' + data[opts.nodeKPI] + '</div></div></div><div class="d-flex flex-row org_box_bottom"><div class="orgiz_scorecard_btn"><a href="#"><button class="button orgiz_btn_scorecard green_color" name="scorecard" value=""><span>S</span></button> </a></div><div class="orgiz_kpi_btn"><a href="#"><button class="button orgiz_btn_kpi orange_color" name="kpi name" value=""><span>K</span></button> </a></div><div class="orgiz_initiative_btn"><a href="#"><button class="button orgiz_btn_init yellow_color" name="initiative" value=""><span>I</span></button> </a></div><div class="orgiz_scorecard_btn"><a href="#"><button class="button orgiz_btn_appraisal green_color" name="appraisal" value=""><span>A</span></button> </a></div></div></div>' : '');
				var deptname	=	(data[opts.nodeDept] !=	undefined?data[opts.nodeDept]:"");
				var orgtitlechart	=	(data[opts.nodeTitle] !=	undefined?data[opts.nodeTitle]:"");
				/*if(orgbottomboxlink ==	true){
                	$nodeDiv.append(typeof opts.nodeContent !== 'undefined' ? '<div class="">'+canMaintain+'<div class="d-flex flex-row org_box_top"><div class="flex-column"><img class="rounded-circle orgiz_image" src="' + image + '" width="25" alt="user"></div><div class="flex-column org_box_top_content"><input type="hidden" class="org_id"  value="' + data[opts.nodeId] + '" /><div class="orgiz_name">' + data[opts.nodeName] + '</div><div class="orgiz_title">' + orgtitlechart + '</div><div class="orgiz_department">' + deptname + '</div></div></div><div class="d-flex flex-row org_box_bottom" style="display:'+linkdesignenable+'">'+scoreCardLandingUrl+initiativeLandingUrl+kpiLandingUrl+appraisalUrl+'</div></div>' : '');
                }else{
                	$nodeDiv.append(typeof opts.nodeContent !== 'undefined' ? '<div class="">'+canMaintain+'<div class="d-flex flex-row org_box_top"><div class="flex-column"><img class="rounded-circle orgiz_image" src="' + image + '" width="25" alt="user"></div><div class="flex-column org_box_top_content"><input type="hidden" class="org_id"  value="' + data[opts.nodeId] + '" /><div class="orgiz_name">' + data[opts.nodeName] + '</div><div class="orgiz_title">' + orgtitlechart + '</div><div class="orgiz_department">' + deptname + '</div></div></div><div class="d-flex flex-row org_box_bottom" style="display:none !important;">'+scoreCardLandingUrl+initiativeLandingUrl+kpiLandingUrl+appraisalUrl+'</div></div>' : '');
                }*/
				//var getownershortName = hasWhiteSpaceName(data[opts.nodeName]);
				var name	=	"";
				var getownershortName 	= 	"";
				var nodelistcontainname	=	"";
				var ownername	=	"";
				if(data[opts.nodeName]	!=	undefined && data[opts.nodeName]	!=	""){
					name	=	data[opts.nodeName];
					getownershortName	=	data[opts.nodeName];
					nodelistcontainname	=	'<div class="orgiz_name" data-id="'+data[opts.nodeId]+'" style="cursor:pointer;">' + name + '</div><div class="orgiz_title">' + orgtitlechart + '</div><div class="orgiz_department">' + deptname + '</div>';
				}
				
				if(data[opts.nodedownerName]	!=	undefined && data[opts.nodedownerName]	!=	"" && data[opts.nodedownerName]	!=	null){
					ownername	=	data[opts.nodedownerName];
				}
				
				if(data[opts.nodedeptName]	!=	undefined && data[opts.nodedeptName]	!=	"" && data[opts.nodedeptName]	!=	null){
					name	=	data[opts.nodedeptName];
					getownershortName	=	data[opts.nodedeptName];
					nodelistcontainname	=	'<div class="orgiz_name" data-id="'+data[opts.nodedeptowner]+'" style="cursor:pointer;">' + name + '</div><div class="orgiz_title">' + ownername + '</div><div class="orgiz_department">' + deptname + '</div>';
				}
				
				var imagelementchart	=	"";
				var checkimageset 		= 	'';
				if(image ==	""){
					checkimageset	=	"imagenotset";
					imagelementchart	=	'<img class="rounded-circle orgiz_image '+checkimageset+' orgchartuserimage" data-name="' + getownershortName + '" width="25" alt="user">';
				}else{
					checkimageset	=	"imageset";
					imagelementchart	=	'<img class="rounded-circle orgiz_image '+checkimageset+'" src="' + image + '" width="25" alt="user">';
				}
				if(data.message == "no OrgStructure Access"){
					$nodeDiv.append(typeof opts.nodeContent !== 'undefined' ? '<div class="noorgaccess" style="white-space:nowrap;">No Organisation Structure Available</div>' : '');
				}else{
					$nodeDiv.append(typeof opts.nodeContent !== 'undefined' ? '<div class="orgiz_structure_div">'+canMaintain+'<div class="d-flex flex-row org_box_top"><div class="flex-column">'+imagelementchart+'</div><div class="flex-column org_box_top_content"><input type="hidden" class="org_id"  value="' + data[opts.nodeId] + '" /><input type="hidden" class="org_canedit_ornot"  value="' + data.canMaintain + '" />'+nodelistcontainname+'</div></div><div class="d-flex flex-row org_box_bottom" style="display:'+linkdesignenable+'">'+scoreCardLandingUrl+initiativeLandingUrl+kpiLandingUrl+riskUrl+'</div></div>' : '');
				}	
            }
            //
