 ...
 *  com.estrat.service.db.repository.FormulationSubRiskRepository
 *  com.estrat.service.db.repository.RiskFormulationMappingRepository
 *  com.estrat.service.db.repository.RiskFormulationRepository
...
import com.estrat.service.db.repository.FormulationRiskActivityRepository;
import com.estrat.service.db.repository.FormulationRiskRepository;
import com.estrat.service.db.repository.FormulationSubRiskRepository;
import com.estrat.service.db.repository.RiskFormulationMappingRepository;
import com.estrat.service.db.repository.RiskFormulationRepository;
...
public class RiskFormulationService {
    ...
    public boolean deleteFormulationRiskActivity(long activityId) {
        ...
        if (result.isPresent()) {
            ...
            this.riskActivityRepository.delete((Object)formulationRiskActivities);
            return true;
        }
        return false;
    }
    ...
    public boolean deleteFormulationSubRisk(long subRiskId) {
        ...
        if (result.isPresent()) {
            ...
            this.formulationSubRiskRepository.delete((Object)formulationSubRiskDetails);
            return true;
        }
        return false;
    }
    ...
    public boolean deleteFormulationRisk(long riskId) {
        ...
        if (result.isPresent()) {
            ...
            this.formulationRiskRepository.delete((Object)formulationRiskDetails);
            return true;
        }
        return false;
    }
    ...
    public boolean deleteFormulation(long formulationId) {
        ...
        if (riskFormulation.isPresent()) {
            ...
            formulation.getRiskList().forEach(risk -> {
                List formulationSubRiskList = risk.getSubRiskList();
                formulationSubRiskList.forEach(subRisk -> subRisk.getSubRiskUserList());
            });
            this.riskFormulationRepository.delete((Object)formulation);
            return true;
        }
        return false;
    }
    ...
    public List<FormulationRiskDTO> getRiskListByDept(long formulationId, String department) {
        List riskList = this.formulationRiskRepository.findByDept(department, Long.valueOf(formulationId));
