 ...
 *  com.estrat.service.db.bean.ChildParentMapper
 ...
 *  com.estrat.service.db.dao.KPIDAO$MeasureNameMapper
...
import com.estrat.service.db.bean.ChildParent;
import com.estrat.service.db.bean.ChildParentEmp;
import com.estrat.service.db.bean.ChildParentEmpMapper;
import com.estrat.service.db.bean.ChildParentMapper;
import com.estrat.service.db.bean.Employee;
import com.estrat.service.db.bean.KpiListMapper;
...
public class KPIDAO {
    ...
    public Map<Long, String> getDepartmentList(long deptId, String name) {
        ...
        try {
            List deptchart = this.jdbcTemplate.query(query.toString(), (RowMapper)new ChildParentMapper());
    ...
    public Map<Long, List<ChildParentEmp>> getEmployeeListRecursive(long empId, Date fromDate, Date toDate) {
        ...
        query = query.replace("toreplacefromDate", String.valueOf(formattedfromDate));
        try {
            List empchart = this.jdbcTemplate.query(query.toString(), (RowMapper)new ChildParentEmpMapper());
    ...
    public Map<Long, String> getEmployeeList(long empId) {
        ...
        try {
            ...
            this.log.error((Object)("ExceptionOccured " + ExceptionLogHelper.convertToString((Exception)((Object)e))));
            throw new RuntimeException(e);
        }
        catch (Exception e) {
    ...
    public List<Map<String, Object>> getAnnualTarget(KPICriteria kpiCriteria, long startYear, long endYear) {
        ...
        try {
            ...
            this.log.error((Object)("ExceptionOccurred " + ExceptionLogHelper.convertToString((Exception)((Object)e))));
            throw new RuntimeException(e);
        }
        catch (Exception e) {
            this.log.error((Object)("ExceptionOccurred " + ExceptionLogHelper.convertToString((Exception)e)));
            throw new RuntimeException(e);
        }
        return kpiDetailsList;
    }
        ...
        try {
            ...
            if (!kpi.isEmpty()) {
                ...
                if (kpiname != null) {
                    ...
                    this.log.error((Object)("kpiname ExceptionOcccured " + query));
                }
            } else {
                this.log.error((Object)("ExceptionOcccured " + query));
            }
        }
        catch (DataAccessException e) {
            this.log.error((Object)("ExceptionOcccured " + ExceptionLogHelper.convertToString((Exception)((Object)e))));
    ...
    public KPIDetailsPo validateAndUpdate(KPIDetailsPo kpiDetailsPo) {
        ...
        List kpiDetailsList = null;
        try {
            this.log.debug((Object)("Org Details query " + query.toString()));
    ...
    public List<Map<String, Object>> getOrgKPIDetailsSubMeasure(KPICriteria kpiCriteria, String query) {
        ...
        try {
            ...
            String kpiFormulaQuery = null;
            kpiFormulaQuery = kpiCriteria.isRetrieveYTD() ? query.replaceAll("where_replace", builder.toString()) : builder.toString();
            this.log.debug((Object)("KPI Formula query " + kpiFormulaQuery));
            kpiDetailsList = this.jdbcTemplate.queryForList(kpiFormulaQuery, paramList.toArray(new Object[paramList.size()]));
        }
        catch (DataAccessException e) {
            this.log.error((Object)("ExceptionOcccured " + ExceptionLogHelper.convertToString((Exception)((Object)e))));
    ...
    public Map<String, Object> getOrgKPIDetailsDeptFunctionData(KPICriteria kpiCriteria, String query, List<Long> departmentList, Boolean includeall, DepartmentChartMapping deptdata, DepartmentChartMapping parentDeptData) {
        ...
        try {
            ...
            String kpiFormulaQuery = builder.toString();
            this.log.info((Object)("KPI Formula query " + kpiFormulaQuery));
            kpiDetailsList = this.jdbcTemplate.queryForMap(kpiFormulaQuery, paramList.toArray(new Object[paramList.size()]));
        }
        catch (DataAccessException e) {
            this.log.error((Object)("ExceptionOcccured " + ExceptionLogHelper.convertToString((Exception)((Object)e))));
