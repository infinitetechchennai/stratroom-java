 ...
 *  com.estrat.service.db.config.LdapConfig
...
import com.estrat.service.db.config.LdapConfig;
...
public class EmployeeDAO {
    ...
    public String encodedPassword(String password) {
        ...
        try {
            ...
            this.log.debug((Object)("encodedPassword() \t the encoded password is " + encodedPassword));
        }
        catch (Exception e) {
            this.log.error((Object)("Error occured while encryption " + ExceptionLogHelper.convertToString((Exception)e)));
    ...
    public String getOrgMaxId() {
        try {
            ...
            this.log.error((Object)("DataAccessException occurred: " + ExceptionLogHelper.convertToString((Exception)((Object)e))));
            throw e;
        }
        catch (Exception e) {
            this.log.error((Object)("Exception occurred: " + ExceptionLogHelper.convertToString((Exception)e)));
            throw new RuntimeException(e);
        }
    }
    ...
    public List<Employee> getEmployeeListByEmpIdList(List<Long> empIds) {
        try {
            List employeeList = this.employeeProfilePoRepo.findByEmpIdIn(empIds);
