...
@Entity
@Table(name="processenabler", schema="orgstructure")
public class ProcessEnabler {
    ...
    public ProcessEnabler() {
    }

    public ProcessEnabler(ProcessEnablerDto processEnablerDto) {
        this.id = processEnablerDto.getId();
        ...
        Long pageId = processEnablerDto.getPageId();
        if (pageId != null && pageId != 0L) {
            PagesDetails pagesDetails = new PagesDetails();
            pagesDetails.setId(processEnablerDto.getPageId().longValue());
