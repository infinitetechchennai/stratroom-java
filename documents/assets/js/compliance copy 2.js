    ...
    table = $('#table-compliance').DataTable({
            ...
            const data = $.map(columns, function (col) {
              ...
              return `
                <li data-row="${rowIdx}" data-column="${col.columnIndex}">
                  ...
                  <div class="dtr-data ${columnClass}">
                    ${cellContent}
                  </div>
                </li>
              `;
      ...
      columns: [
        ...
        },
        {
          ...
          render: function (data) {
            return `<div class="editableControl_description" data-field="control_description">${data || "N/A"}</div>`;
          }
        },
        {
          ...
          render: function (data) {
            return `<div class="editableCompliance_area" data-field="compliance_area">${data || "N/A"}</div>`;
          }
        },
        {
          data: 'regulation',
          ...
          render: function (data) {
            return `<div class="editableRegulations" data-field="regulation">${getRegulationBadges(data)}</div>`;
          }
        },
        {
          data: 'owner',
        ...
        },
        {
          ...
          render: function (data) {
            return `<div class="editableRisk_level" data-field="risk_level">${getRiskLevelBadge(data)}</div>`;
          }
        },
        {
          data: 'control_type',
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableControl_type" data-field="control_type">${getControlTypeBadge(data)}</div>`;
          }
        },
        {
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableImplementation_status" data-field="implementation_status">${getImplementationStatusBadge(data)}</div>`;
          }
        },
        {
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableLast_assessment_date" data-field="last_assessment_date">${data || "N/A"}</div>`;
          }
        },
        {
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableNext_review_date" data-field="next_review_date">${data || "N/A"}</div>`;
          }
        },
        {
          data: 'status',
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableStatus" data-field="status">${getStatusBadge(data)}</div>`;
          }
        },
        {
          data: 'audit_required',
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableAudit_required" data-field="audit_required">${getAuditRequiredBadge(data)}</div>`;
          }
        },
        {
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableLast_audit_date" data-field="last_audit_date">${data || "N/A"}</div>`;
          }
        },
        {
          data: 'audit_findings',
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableAudit_findings" data-field="audit_findings">${data || "N/A"}</div>`;
          }
        },
        {
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableCorrective_actions" data-field="corrective_actions">${data || "N/A"}</div>`;
          }
        },
        {
          ...
          defaultContent: 'N/A',
          render: function (data) {
            return `<div class="editableAction_due_date" data-field="action_due_date">${data || "N/A"}</div>`;
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data) {
            if (!data) return 'N/A';
            return `<a href="${data}" download class="btn btn-sm btn-icon text-decoration-none">
