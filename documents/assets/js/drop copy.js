    ...
    <div class="g-col-12 g-col-md-4 g-col-lg-2">
          <div class="card text-start text-card text-card-main border">
            <div class="card-header border-0 bg-transparent pb-0 px-2 gap-1 d-flex align-items-center justify-content-between">
              <div class="icon">
                <img width="18" height="18" src="assets/images/icons/risk-management-i.svg" alt="risk-management">
              </div>
    ...
    $("#text-body").append(`
      <div class="g-col-12 g-col-md-4 g-col-lg-2">
          <div class="card text-start text-card text-card-main border">
            <div class="card-header border-0 bg-transparent pb-0 px-2 gap-1 d-flex align-items-center justify-content-between">
              <div class="icon">
                <img width="18" height="18" src="assets/images/icons/initiatives-i.svg" alt="initiatives">
              </div>
              <div class="text-muted period ms-auto">
                Jan 2019 - Dec 2020
              </div>
    ...
    $("#text-body").append(`
      <div class="g-col-12 g-col-md-4 g-col-lg-2">
          <div class="card text-start text-card text-card-main border">
            <div class="card-header border-0 bg-transparent pb-0 px-2 gap-1 d-flex align-items-center justify-content-between">
              <div class="icon">
                <img width="18" height="18" src="assets/images/icons/personal-dashboard-i.svg"" alt="personal-dashboard">
              </div>
              <div class="text-muted period ms-auto">
                Jan 2019 - Dec 2020
              </div>
