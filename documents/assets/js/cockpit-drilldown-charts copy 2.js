    ...
    function traverse(node) {
      ...
      if (node.data?.monthly) {
        ...
        Object.keys(monthlyData).forEach(month => {
          ...
          const actualVal = parseFloat(monthlyData[month].actual.split(' ')[0]) * 1000000;
          const targetVal = parseFloat(monthlyData[month].target.split(' ')[0]) * 1000000;
