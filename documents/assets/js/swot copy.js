...
function groupByName(data) {
        const grouped = {};
        data.forEach(item => {
            const category = item.name || "Unnamed";
            if (!grouped[category]) grouped[category] = [];
            grouped[category].push(item);
             // push children too
        if (item.children && item.children.length > 0) {
            item.children.forEach(c => {
                c.parentName = item.name; // optional
...
<td class="text-start text-nowrap"><div class="d-flex gap-1 flex-wrap" style="min-width:260px">${item.description || ""}</div></td>
<td class="text-start text-nowrap"><div class="d-flex gap-1 flex-wrap" style="min-width:260px">${item.department || ""}</div></td>
<td class="text-start text-nowrap"><div class="d-flex gap-1 flex-wrap" style="min-width:260px">${item.businessImpact || ""}</div></td>
<td class="text-start text-nowrap"><div class="d-flex gap-1 flex-wrap" style="min-width:260px">${item.nextDue || ""}</div></td>
<td class="text-start text-nowrap"><div class="d-flex gap-1 flex-wrap" style="min-width:260px">${item.responsible || ""}</div></td>
<td class="text-start text-nowrap"><div class="d-flex gap-1 flex-wrap" style="min-width:260px">${item.status || ""}</div></td>
                                                            ...
                                                            <ul class="list-unstyled action-list">
                                                                <li>
                                                                    <a href="#notes-modal" data-bs-toggle="modal">
                                                                        <span class="icon" data-bs-toggle="tooltip"
                                                                            ...
                                                                            data-bs-title="Notes">
                                                                           <i data-lucide="notebook-pen" style="width: 12px; height: 12px;"></i>
                                                                        </span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li class="dropdown">
                                                                    <a class="btn btn-link p-0 show" type="button"
                                                                        ...
                                                                        <span class="icon">
                                                                            <i data-lucide="ellipsis-vertical" style="width: 12px; height: 12px;"></i>
                                                                        </span>
                                                                    </a>
