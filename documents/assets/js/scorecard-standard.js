        ...
        tabs.forEach((tab, index) => {
            ...
            tabContent.append(`<div id="${tabId}" class="tab-pane fade ${isActive}">
                ...
                <table class="table table-bordered w-100" id="table-${tablePrefix}">
                    <thead>
                        <tr>
                            <th data-translate="page.scorecard.scorecardListItems.status">Status</th>
                            <th data-translate="page.scorecard.scorecardListItems.id">ID</th>
                            <th data-translate="page.scorecard.scorecardListItems.name">Name</th>
                            <th data-translate="page.scorecard.scorecardListItems.period">Period</th>
                            <th data-translate="page.scorecard.scorecardListItems.score">Score</th>
                            <th data-translate="page.scorecard.scorecardListItems.trend">Trend</th>
                            <th data-translate="page.scorecard.scorecardListItems.baseline">Baseline</th>
                            <th data-translate="page.scorecard.scorecardListItems.actual">Actual</th>
                            <th data-translate="page.scorecard.scorecardListItems.target">Target</th>
                            <th data-translate="page.scorecard.scorecardListItems.risk">Risk</th>
                            <th data-translate="page.scorecard.scorecardListItems.actions">Actions</th>
                        </tr>
                    </thead>
