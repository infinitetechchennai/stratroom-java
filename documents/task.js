...
let actionsMenu = getActionsMenu();
            ...
            html += `<tr class="level-${level}" data-id="${rowId}" data-group-id="${groupId}" style="${displayStyle}">
                ...
                <td class="text-center text-nowrap">${item.start_date || ""}</td>
                <td class="text-center text-nowrap">${item.due_date || ""}</td>
  ...
  <td class="text-center text-nowrap">${item.attachments ? 
    ...
    ""
                ...
                <td class="text-center"><div class="table-actions justify-content-end">${actionsMenu}</div></td>
            </tr>`;
