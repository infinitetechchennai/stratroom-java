        ...
        return web -> {
            try {
                ...
                web.ignoring()
                        ...
                        // PathPatternParser (used by Spring Security 6 MvcRequestMatcher)
                        // rejects "/**/*.map" -- '**' must be the final element.
                        // Without this fix MvcRequestMatcher.matches() throws
                        // PatternParseException during filter-chain selection, which
                        // causes /user/permissions, /moduleList, /rolesList, etc.
                        // to fall through to the static-resource handler and 404
                        // ("No static resource user/permissions"). admin.js's permission
                        // loader then sees an empty response and shows
                        // "You don't have any access, pls contact administrator".
                        .requestMatchers("/*.map")
