...
public class ControlPanelThemeService {
    ...
    @Value(value="${userService.control.panel.theme.url}")
    private String dbUrl;
    @Value(value="${userService.control.panel.theme.list.url}")
    ...
    public ControlPanelResponseDTO saveControlPanelTheme(ControlPanelThemeDTO controlPanelThemeDTO) {
        return (ControlPanelResponseDTO)this.commonRestTemplate.postForObject(this.dbUrl, controlPanelThemeDTO, ControlPanelResponseDTO.class);
    }

    public ControlPanelResponseDTO updateControlPanelTheme(ControlPanelThemeDTO controlPanelThemeDTO) {
        return (ControlPanelResponseDTO)this.commonRestTemplate.putForObject(this.dbUrl, controlPanelThemeDTO, ControlPanelResponseDTO.class);
    }
