...
<div class="col-lg-6 col-md-6 select-toggle {{showhidetitle}}" style="display:{{displayblock}}">
    <div class="card">
		...
		<span style="color: black;font-size: 13px;font-weight: 600;position: absolute;left: -43px; background-color: #883B71 !important;">{{scorecardStatusvalueofweight}}</span>
            <h2 class="prob">
                <strong class="perspective" style="background-color: #883B71 !important;">{{title}}</strong>
			</h2>
