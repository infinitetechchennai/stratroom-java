				...
				$(document).ready(function () {
					...
					$.ajax({
						...
						error: function(xhr, status, err) {
							// Notifications endpoint failed -- show a friendly empty state instead of the red error.
							console.debug("Notifications unavailable:", err && err.message ? err.message : err);
