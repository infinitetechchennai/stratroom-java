...
<head>
    ...
    <link href="../../assets/css/org_structure_kpi_edit.css" rel="stylesheet">
    <style>
        html,
        body {
            font-family: poppins;
...
<body class="light">
    ...
    <div>
                                    ...
                                    <li class="center">
                                        <form id="profileForm">
                                            <div class="form-group">
                                                ...
                                                <div class="form-line">
                                                    <label for="name" class="left" data-i18n="Name">Name</label>
                                                ...
                                                <div class="form-line center">
                                                    <button class="btn-default1 btn cancelEditProfile" value="Cancel" data-i18n="Cancel">Cancel</button>
                                                                            ...
                                                                            <li class="row">
                                                                                <form id="reportingAddForm">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="form-line center">
                                                                                            <button class="btn-default1 btn canceladdReporting" value="Cancel" data-i18n="Cancel">Cancel</button>
                                                                                            <button class="btn-default btn-black" value="Submit">Submit</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            ...
                                                                            <li class="row">
                                                                                <form id="directAddForm">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="form-line center">
                                                                                            <button class="btn-default1 btn canceladdDirect" value="Cancel" data-i18n="Cancel">Cancel</button>
                                                                                            <button class="btn-default btn-black" value="Submit">Submit</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                            ...
                                                            <div id="collapseOne_3" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_3">
                                                                <div class="panel-body profile_edit">
                                                                    <ul class="ml-menu profile_accordion">
                                                                        ...
                                                                        <li>
                                                                            <a href="#" data-i18n="My Initiatives">My Initiatives</a>
                                                                        </li>
                                                                        <li>
            ...
            <form id="add_org_structure_form">
                <div class="form-group">
                    ...
                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="name" class="left" data-i18n="Department">Department</label>
                        <input type="text" name="dept1" id="dept1" class="form-control browser-default" />
                    </div>
                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="name" class="left">KPI Description</label>
                        <!-- <input type="text" name="desc1" id="desc1" class="form-control browser-default"> -->
                        <textarea name="desc1" id="desc1" class="form-control browser-default"></textarea>
                    </div>
                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="name" class="left" data-i18n="Actual">Actual</label>
                        <input type="text" name="actual1" id="actual1" class="form-control browser-default">
                    </div>
                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="title" class="left" data-i18n="Target">Target</label>
                        <input type="text" name="target1" id="target1" class="form-control browser-default">
                    </div>
                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="title" class="left" data-i18n='Gap'>Gap</label>
                        <input type="text" name="gap1" id="gap1" class="form-control browser-default">
                    </div>
                    <div class="form-line p-l-10 p-t-5 center">
                        <input type="button" role="button" class="btn canceladdReporting" id="close-org-aside1" value="Cancel" data-i18n="Cancel"/>
                        <input type="button" role="button" class="org_struct_add_btn" id="add-org-object" value="Add" />
                    </div>
                </div>
            </form>
        </aside>
        ...
        <aside id="Edit_Org_Structure" class="edit_org_structure-sidebar">
            <form id="edit_org_structure_form">
                <div class="form-group">
                    <input type="hidden" name="org_new_id" id="org_new_id" />

                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="name" class="left" data-i18n="Department">Department</label>
                        <input type="text" name="dept" id="dept" class="form-control browser-default" />
                    </div>
                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="name" class="left">KPI Description</label>
                        <!-- <input type="text" name="desc" id="desc" class="form-control browser-default"> -->
                        <textarea name="desc" id="desc" class="form-control browser-default"></textarea>
                    </div>
                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="name" class="left" data-i18n="Actual">Actual</label>
                        <input type="text" name="actual" id="actual" class="form-control browser-default">
                    </div>
                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="title" class="left" data-i18n="Target">Target</label>
                        <input type="text" name="target" id="target" class="form-control browser-default">
                    </div>
                    <div class="form-line p-l-10 p-t-5 p-r-5 mb-2">
                        <label for="title" class="left" data-i18n='Gap'>Gap</label>
                        <input type="text" name="gap" id="gap" class="form-control browser-default">
                    </div>

                    <div class="form-line p-l-10 p-t-5 p-r-5 center">
                        <input type="button" role="button" class="btn canceladdReporting" id="close-org-aside" value="Cancel" />
                        <input type="button" role="button" class="org_struct_save_btn" id="edit-org-object" value="Save" />
                    </div>
                </div>
            </form>
        </aside>
    ...
    <script src="../../assets/jquery.orgchart_kpi_edit.js"></script>
    <script src="../../assets/js/org_structure_kpi_edit.js"></script>
</body>