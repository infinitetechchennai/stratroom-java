    ...
    this.server.read(t, this.width(), this.height(), e, v, y, function(t) {
        ...
        t.visibleNodes) {
            var l = t.visibleNodes[o]
              , s = b._get(o);
            r += b.ui.node(l, s, t.animations, b.config, void 0, void 0, void 0, v, i, b),
        ...
        if (OrgChart.events.publish("render", [b, e]),
        r = e.content,
        r += b.ui.lonely(b.config),
        v !== OrgChart.action.exporting) {
            v !== OrgChart.action.centerNode && v !== OrgChart.action.insert && v !== OrgChart.action.expandCollapse && v !== OrgChart.action.update || (n = a),
            ...
            if (b._initialized) {
                ...
                b.element.innerHTML = b.ui.css() + b.ui.exportMenuButton(b.config) + O,
                b._attachInitEventHandlers(),
                b._attachEventHandlers(),
                b.config.showXScroll === OrgChart.scroll.visible && (b.xScrollUI.create(b.width(), b.config.padding),
                b.xScrollUI.setPosition(),
                b.xScrollUI.addListener(b.getSvg())),
                b.config.showYScroll === OrgChart.scroll.visible && (b.yScrollUI.create(b.height(), b.config.padding),
                b.yScrollUI.setPosition(),
                b.yScrollUI.addListener(b.getSvg())),
                b.config.enableSearch && b.searchUI.addSearchControl(),
                b.toolbarUI.init(b, b.config.toolbar);
                var c = document.createElement("div");
                c.setAttribute("id", "bg-tests"),
            ...
            v === OrgChart.action.centerNode ? OrgChart.anim(b.getSvg(), {
                ...
                b._showAfterAnimation(),
                g = !0)
            }) : !a || !b.response || a[0] == b.response.viewBox[0] && a[1] == b.response.viewBox[1] && a[2] == b.response.viewBox[2] && a[3] == b.response.viewBox[3] || v !== OrgChart.action.insert && v !== OrgChart.action.expandCollapse && v !== OrgChart.action.update && v !== OrgChart.action.init ? 0 == p[0].length && (g || (x && x(),
            OrgChart.events.publish("redraw", [b]),
            g = !0)) : OrgChart.anim(b.getSvg(), {
                viewbox: a
            }, {
                viewbox: b.response.viewBox
...
OrgChart._updateDB = function(t, e) {
	var xmlhttp = new XMLHttpRequest(); 
	var editUrl = "editEmployee";
	xmlhttp.open("POST", editUrl);
	xmlhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
	xmlhttp.send(JSON.stringify(t));
}

OrgChart._removeFromDB = function(t, e) {
	var xmlhttp = new XMLHttpRequest();
	var removeUrl = ""+t+"/removeEmployee";
	xmlhttp.open("DELETE", removeUrl);
	xmlhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
	xmlhttp.send();
}
,
        ...
        function(r) {
            s._draw(!1, OrgChart.action.exporting, t, function(t) {
                ...
                OrgChart._imgs2base64(a, "image", "xlink:href", function() {
                    ...
                    g.length - 1 == n && (s.config.collapse = h,
                    s.config.roots = d,
                    l(c))
                })
            })
...
OrgChart.prototype._nodeMouseDownHandler = function(t, e, o) {
    if (this.config.enableDragDrop) {
        ...
        var d = this
          ...
          , C = d.getScale()
          , m = t.cloneNode(!0);
        if (c.insertBefore(m, c.firstChild),
        m.style.opacity = .7,
        l.isChildOfGroup) {
        ...
        var O = function(t) {
            ...
            if (null != s && ((e = d.getBGNode(s)).isChildOfGroup ? (d.getNodeElement(e._groupParentNodeId).style.opacity = 1,
            h.style.opacity = 1) : e.isGroup || (h.style.opacity = 1)),
            h = s = null,
            ...
            null != s && ((e = d.getBGNode(s)).isChildOfGroup ? (d.getNodeElement(e._groupParentNodeId).style.opacity = .8,
            h.style.opacity = .5) : e.isGroup ? h = s = null : h.style.opacity = .5);
            var n = (r.x - g.x) / C
              , o = (r.y - g.y) / C;
            p[4] = f + n,
            p[5] = u + o,
          ...
          , v = function(t) {
            if (c.removeEventListener(o.move, O),
            c.removeEventListener(o.up, v),
            o.leave && c.removeEventListener(o.leave, v),
            l.id == s || l.isChildOfGroup && l._groupParentNodeId == s || null == s)
                return c.removeChild(m),
                void (d._gragStartedId = null);
            var e = d.getBGNode(s);
...
OrgChart.server._createNodes = function(t, e, r, i) {
    for (var a = t.nodes, n = {}, o = [], l = [], s = [], h = {}, d = !1, c = 0; c < a.length; c++) {
        ...
        if ((y = new OrgChart.node(g.id,g.pid,C,p,u)).isAssistant = -1 != p.indexOf("assistant"),
    ...
    for (c = 0; c < o.length; c++) {
        ...
        if (null != y.pid && null != y.pid && "" !== y.pid)
            (_ = n[y.pid]) ? ((y.parent = _).children.push(y),
            _.childrenIds.push(y.id)) : (y.pid = null,
            y.parent = null,
            l.push(y));
        else
            l.push(y);
        ...
        OrgChart.server._setNodeGroupState(y, x.groupState, t.orientation)) : OrgChart.server._setNodeGroupState(y, OrgChart.EXPAND, t.orientation),
            ...
            if (b) {
                if (b.parent)
                    for (var w = (_ = b.parent).children.length - 1; 0 <= w; w--) {
                        (U = _.children[w]) == b && (U.parent = null,
    ...
    for (c = 0; c < s.length; c++) {
        ...
        if (A.length % 2) {
            ...
            (W = new OrgChart.node(_.id + "_transperant",S.pid,null,[],N)).isAssistant = !0,
            n[W.id] = W,
        ...
        for (w = A.length - 1; 0 <= w; w--) {
            if (w % 2 && w != A.length - 1)
                (J = new OrgChart.node(_.id + "_split_" + M,null,null,[],"split")).isAssistant = !0,
                n[J.id] = J,
                A.splice(w, 0, J.id),
                M++;
            else
    ...
    if (e == OrgChart.action.centerNode) {
        ...
        for (var z = P.id; null != _; ) {
            if (-1 != (D = O.indexOf(_.id)) && O.splice(D, 1),
            ...
            r.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS)
                for (c = 0; c < _.childrenIds.length; c++) {
                    ...
                    if (!OrgChart.server._isSplit(U) && !U.isAssistant && U.id != z)
                        -1 == (D = O.indexOf(_.childrenIds[c])) && O.push(_.childrenIds[c]),
        ...
        if (r.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
            for (c = 0; c < P.childrenIds.length; c++) {
                if (-1 != (D = O.indexOf(P.childrenIds[c])) && O.splice(D, 1),
                ...
                !U.isAssistant && !OrgChart.server._isSplit(U))
                    for (w = 0; w < U.childrenIds.length; w++) {
                        ...
                        -1 == (D = O.indexOf(U.childrenIds[w])) && O.push(U.childrenIds[w]),
    ...
    for (c = 0; c < O.length; c++) {
        if (_ = (y = n[O[c]]).parent)
            for (w = _.children.length - 1; 0 <= w; w--) {
                if (_.children[w] == y)
                    if (-1 == _.collapsedChildrenIds.indexOf(y.id) && _.collapsedChildrenIds.push(y.id),
                    _.children.splice(w, 1),
    ...
    if (t.layout == OrgChart.tree || t.layout == OrgChart.treeRightOffset || t.layout == OrgChart.treeLeftOffset) {
        ...
        for (c = 0; c < q.length; c++) {
                ...
                if (OrgChart.server._mixedLayoutAllNodes(_))
                    if (0 == (U = _.children[w]).childrenIds.length && !U.isAssistant && "split" != U.templateName && (U.parent && "split" != U.parent.templateName || U.parent.isAssistant)) {
                        ...
                        t.layout == OrgChart.treeLeftOffset || t.layout == OrgChart.treeRightOffset) {
                            ...
                            (W = new OrgChart.node(U.id + "_transperant",null,null,[],N)).layout = OrgChart.tree,
                            n[W.id] = W,
                            V.splice(0, 0, W.id)
                        }
                        t.layout != OrgChart.treeRightOffset && V.splice(0, 0, U.id)
            ...
            w = V.length - 1; 0 <= w; w--) {
                var J;
                if (w % 2 && w != V.length - 1)
                    (J = new OrgChart.node(_.id + "_split_" + M,null,null,[],"split")).layout = OrgChart.tree,
                    n[J.id] = J,
                    V.splice(w, 0, J.id),
                    M++;
                else
    ...
    if (r == OrgChart.action.init && t) {
        if (t.tags)
            for (var o = 0; o < t.tags.length; o++) {
                var l = t.tags[o];
                i.tags && i.tags[l] && null != i.tags[l].state && (i.tags[l].state == OrgChart.COLLAPSE && n.push(t.id),
...
OrgChart.server._expandCollapseToLevel = function(t, e, r, i, a, n) {
    if (i.collapse.level) {
        ...
        if (o >= i.collapse.level) {
            ...
            t.state = OrgChart.COLLAPSE) : s || i.collapse.allChildren || o != i.collapse.level || (n.push(t.id),
    ...
    for (var S in g) {
        ...
        if (OrgChart.server._isVisible(I, i, s, d)) {
            ...
            if (d == OrgChart.action.expandCollapse && f && f[I.id] && "expandCollapseToLevel" == c.method) {
                ...
                d !== OrgChart.action.exporting && r && !r[I.id] && (m[0].push(I.id),
                m[1].push({
                    opacity: 0
                }),
                m[2].push({
            ...
            null != N && null != N.x && null != N.y && (N.x == I.x && N.y == I.y || (m[0].push(I.id),
            m[1].push({
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        t.isGroup) {
            ...
            if (g)
                ...
                c += u = (u = d.groupName.replace("{val}", g)).replaceAll("{randId}", OrgChart._randomId()).replaceAll("{randId2}", OrgChart._randomId());
            c += u
        } else
            for (var p in o) {
                var f = o[p];
                if (e) {
                    ...
                    null != C && null != C && null != d[p])
                        ...
                        d[p].replace("{val}", C))).replaceAll("{randId}", OrgChart._randomId()).replaceAll("{randId2}", OrgChart._randomId())
                }
            }
...
OrgChart.pdfPrevUI._showHide = function(t, e, r) {
    "A4" == t.value || "A3" == t.value || "A2" == t.value || "A1" == t.value ? (e.parentNode.style.display = "block",
    r.parentNode.style.display = "block") : ("A42Levels" == t.value || "A32Levels" == t.value || "A22Levels" == t.value || "A12Levels" == t.value ? e.parentNode.style.display = "block" : e.parentNode.style.display = "none",
...
OrgChart._exportHtml = function(t, e, r, i, a, n) {
    for (var o = "", l = 0; l < e.margin.length; l++)
        o += e.margin[l] + "px ";
    ...
    for (var e, r, i, a, n, o = "", l = 0; l < this.config.clinks.length; l++) {
        ...
        if (h && d) {
            ...
            case OrgChart.orientation.top_left:
                ...
                h.y == d.y ? (m = 1,
                c.y = h.y,
                g.y = d.y) : h.y > d.y ? (c.y = h.y,
                g.y = d.y + d.h) : (c.y = h.y + h.h,
                g.y = d.y);
                break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
            ...
            case OrgChart.orientation.left_top:
                ...
                h.x == d.x ? (m = -1,
                c.x = h.x,
                g.x = d.x) : h.x > d.x ? (c.x = h.x,
                g.x = d.x + d.w) : (c.x = h.x + h.w,
                g.x = d.x);
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
            ...
            s.label && (o += y.label.replace("{x}", x.x).replace("{y}", x.y).replace("{val}", s.label)),
