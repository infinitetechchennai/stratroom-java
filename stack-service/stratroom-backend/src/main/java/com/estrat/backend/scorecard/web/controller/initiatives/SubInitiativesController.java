 ...
 *  com.estrat.backend.scorecard.web.controller.initiatives.SubInitiativesController
...
public class SubInitiativesController {
    ...
    public ResponseEntity<List<SubInitiativesDTO>> findAllByInitiativesId(@PathVariable Long initiativeId) throws RequestException {
        ...
        if (!subInitiativesDTOList.isEmpty()) {
            for (com.estrat.backend.scorecard.dto.SubInitiativesDTO subInitiativesDTO : (java.util.List<com.estrat.backend.scorecard.dto.SubInitiativesDTO>)subInitiativesDTOList) {
