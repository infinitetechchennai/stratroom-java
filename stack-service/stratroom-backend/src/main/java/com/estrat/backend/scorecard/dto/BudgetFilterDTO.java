 ...
 *  com.estrat.backend.scorecard.dto.BudgetFilterDTO
 */
...
public class BudgetFilterDTO {
    ...
    public void setProjectInitiative(String projectInitiative) {
        this.projectInitiative = projectInitiative;
    }

    public String getSubInitiative() {
        return this.subInitiative;
    }

    public void setSubInitiative(String subInitiative) {
