 ...
 *  com.estrat.backend.scorecard.service.StrategyMapService$1
 *  com.estrat.backend.scorecard.service.StrategyMapService$2
    ...
    public List<ScoreCardDTO> findAllScoreCardList(Long pageid, String dateRange) {
        ...
        ParameterizedTypeReference<Object> parameterizedTypescorecard = null;
            ...
            if (scoreCardDetailsDTO != null) {
                ...
                List<ScoreCardDTO> allScoreCards = (List<ScoreCardDTO>) (List) listCalulates.stream().flatMap(map -> ((java.util.Map<String, com.estrat.backend.scorecard.dto.ScoreCardDTO>)map).values().stream()).sorted(Comparator.comparingLong(ScoreCardDTO::getId)).collect(Collectors.toList());
