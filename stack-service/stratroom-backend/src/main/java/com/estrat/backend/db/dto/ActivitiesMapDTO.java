...
public class ActivitiesMapDTO {
    ...
    public ActivitiesMapDTO() {
    }

    public ActivitiesMapDTO(ActivitiesMap activitiesMap) {
        this.id = activitiesMap.getId();
        this.activitiesId = activitiesMap.getActivitiesId().getId();
        this.employeeProfilePos = activitiesMap.getEmployeeProfilePos();
    }
