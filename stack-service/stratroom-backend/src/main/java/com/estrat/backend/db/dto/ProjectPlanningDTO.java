...
public class ProjectPlanningDTO {
    ...
    private long pageId;
    private Map<String, Object> planningValue;
    ...
    public ProjectPlanningDTO() {
    }

    public ProjectPlanningDTO(ProjectPlanning planing) {
        ...
        this.initiativeId = planing.getInitiativeId();
        ...
        try {
            this.planningValue = (Map)mapper.readValue(planing.getPlanningValue(), HashMap.class);
        }
        catch (Exception e) {
    ...
    public Map<String, Object> getPlanningValue() {
        return this.planningValue;
    }

    public void setPlanningValue(Map<String, Object> planningValue) {
