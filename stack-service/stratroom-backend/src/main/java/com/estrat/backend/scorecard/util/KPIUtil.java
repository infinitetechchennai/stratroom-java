...
public class KPIUtil {
    ...
    public Map<String, Integer> buildStatusLightForInitiative(KPIDTO kpidto, SubKPIDTO subkpidto, String flagtype, Map<String, Integer> countMap) {
        ...
        for (com.estrat.backend.scorecard.dto.InitiativesDTO initiativesDTO : (java.util.List<com.estrat.backend.scorecard.dto.InitiativesDTO>)(java.util.List)initiativesDTOList) {
    ...
    public Map<String, Integer> buildStatusLightForRisk(KPIDTO kpidto, SubKPIDTO subkpidto, String flagtype, boolean updateKpiStatus) {
        ...
        for (com.estrat.backend.scorecard.dto.RiskDTO riskDTO : (java.util.List<com.estrat.backend.scorecard.dto.RiskDTO>)(java.util.List)riskDTOList) {
            int score;
