 ...
 *  com.estrat.backend.scorecard.service.MilestonesService
 *  com.estrat.backend.scorecard.util.KPIUtil
 *  com.estrat.backend.scorecard.web.controller.initiatives.MilestonesController
...
import com.estrat.backend.scorecard.service.MilestonesService;
...
public class MilestonesController {
    ...
    public ResponseEntity<List<MilestonesDTO>> findAllByInitiativesId(@PathVariable Long initiativeId) throws RequestException {
        ...
        if (!milestonesDTOSList.isEmpty()) {
            for (com.estrat.backend.scorecard.dto.MilestonesDTO milestonesDTO : (java.util.List<com.estrat.backend.scorecard.dto.MilestonesDTO>)milestonesDTOSList) {
    ...
    public ResponseEntity<List<MilestonesDTO>> findAllByEmpId(@PathVariable(value="empId") Long empId) throws RequestException {
        ...
        if (!mileStonesList.isEmpty()) {
            for (com.estrat.backend.scorecard.dto.MilestonesDTO milestonesDTO : (java.util.List<com.estrat.backend.scorecard.dto.MilestonesDTO>)mileStonesList) {
                this.kpiUtil.updateStatusByProgress(milestonesDTO.getMileStonesValue());
            }
        }
