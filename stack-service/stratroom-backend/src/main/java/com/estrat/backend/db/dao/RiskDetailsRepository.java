...
extends JpaRepository<RiskDetails, Long> {
    ...
    @Query(value="SELECT r FROM RiskDetails r WHERE   (r.owner=:empId OR r.createdBy=:empId) AND r.active =:active  AND r.pageId.id =:pageId AND  (((r.completedDate BETWEEN :startDate AND :endDate)  OR (r.createdTime BETWEEN :startDateLDT AND :endDateLDT)  OR (r.raisedDate BETWEEN :startDate AND :endDate)) OR ((:startDate BETWEEN r.raisedDate AND r.completedDate)  OR (:endDate BETWEEN r.raisedDate AND r.completedDate))) order  by r.id asc")
    public List<RiskDetails> findAllByEmpIdANDDate(@Param(value="empId") Long var1, @Param(value="active") int var2, @Param(value="pageId") Long var3, @Param(value="startDate") Date var4, @Param(value="endDate") Date var5, @Param("startDateLDT") LocalDateTime startDateLDT, @Param("endDateLDT") LocalDateTime endDateLDT);

    @Query(value="SELECT r FROM RiskDetails r WHERE   r.active =:active  AND r.pageId.id =:pageId AND  (((r.completedDate BETWEEN :startDate AND :endDate)  OR (r.createdTime BETWEEN :startDateLDT AND :endDateLDT)  OR (r.raisedDate BETWEEN :startDate AND :endDate)) OR ((:startDate BETWEEN r.raisedDate AND r.completedDate)  OR (:endDate BETWEEN r.raisedDate AND r.completedDate))) order  by r.id asc")
    public List<RiskDetails> findAllByPageANDDate(@Param(value="active") int var1, @Param(value="pageId") Long var2, @Param(value="startDate") Date var3, @Param(value="endDate") Date var4, @Param("startDateLDT") LocalDateTime startDateLDT, @Param("endDateLDT") LocalDateTime endDateLDT);

    @Query(value="SELECT r FROM RiskDetails r WHERE  (r.owner=:empId OR r.createdBy=:empId) AND r.active =:active AND  (((r.completedDate BETWEEN :startDate AND :endDate) OR (r.createdTime BETWEEN :startDateLDT AND :endDateLDT) OR (r.raisedDate BETWEEN :startDate AND :endDate)) OR ((:startDate BETWEEN r.raisedDate AND r.completedDate)  OR (:endDate BETWEEN r.raisedDate AND r.completedDate))) order  by r.id asc")
    public List<RiskDetails> findAllByEmpIdANDDate(@Param(value="empId") Long var1, @Param(value="active") int var2, @Param(value="startDate") Date var3, @Param(value="endDate") Date var4, @Param("startDateLDT") LocalDateTime startDateLDT, @Param("endDateLDT") LocalDateTime endDateLDT);
    ...
    public List<RiskDetails> findAllByPageIdsANDDateRanges(@Param(value="active") int var1, @Param(value="pageIds") List<Long> var2, @Param(value="startDate") Date var3, @Param(value="endDate") Date var4, @Param("startDateLDT") LocalDateTime startDateLDT, @Param("endDateLDT") LocalDateTime endDateLDT);
    ...
    public List<RiskDetails> findByRiskIdsANDDateRanges(@Param(value="ids") List<Long> var1, @Param(value="active") int var2, @Param(value="startDate") Date var3, @Param(value="endDate") Date var4, @Param("startDateLDT") LocalDateTime startDateLDT, @Param("endDateLDT") LocalDateTime endDateLDT);

    @Query(value="SELECT r FROM RiskDetails r WHERE   ( r.owner IN (:empIds)  OR  r.createdBy IN (:empIds) )  AND r.active =:active AND  (((r.completedDate BETWEEN :startDate AND :endDate) OR (r.createdTime BETWEEN :startDateLDT AND :endDateLDT) OR (r.raisedDate BETWEEN :startDate AND :endDate)) OR ((:startDate BETWEEN r.raisedDate AND r.completedDate)  OR (:endDate BETWEEN r.raisedDate AND r.completedDate))) order  by r.id asc")
    public List<RiskDetails> findAllByEmpIdANDDate(@Param(value="empIds") List<Long> var1, @Param(value="active") int var2, @Param(value="startDate") Date var3, @Param(value="endDate") Date var4, @Param("startDateLDT") LocalDateTime startDateLDT, @Param("endDateLDT") LocalDateTime endDateLDT);
