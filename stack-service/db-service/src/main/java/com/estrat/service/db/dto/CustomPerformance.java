...
public class CustomPerformance {
    ...
    private String threshold02Color;
    private String threshold03Color;
    private String threshold04Color;
    private String threshold05Color;
    ...
    public CustomPerformance(Map<String, Object> performanceMap) {
        ...
        this.threshold02Color = Objects.nonNull(performanceMap.get("threshold1_2Color")) ? performanceMap.get("threshold1_2Color").toString() : "";
        this.threshold03Color = Objects.nonNull(performanceMap.get("threshold2Color")) ? performanceMap.get("threshold2Color").toString() : "";
        this.threshold04Color = Objects.nonNull(performanceMap.get("threshold4Color")) ? performanceMap.get("threshold4Color").toString() : "";
        this.threshold05Color = Objects.nonNull(performanceMap.get("threshold5Color")) ? performanceMap.get("threshold5Color").toString() : "";
    ...
    public String getThreshold02Color() {
        return this.threshold02Color;
    }

    public void setThreshold02Color(String threshold02Color) {
        this.threshold02Color = threshold02Color;
    }

    public String getThreshold03Color() {
        return this.threshold03Color;
    }

    public void setThreshold03Color(String threshold03Color) {
        this.threshold03Color = threshold03Color;
    }

    public String getThreshold04Color() {
        return this.threshold04Color;
    }

    public void setThreshold04Color(String threshold04Color) {
        this.threshold04Color = threshold04Color;
    }

    public String getThreshold05Color() {
        return this.threshold05Color;
    }

    public void setThreshold05Color(String threshold05Color) {
        this.threshold05Color = threshold05Color;
    }
