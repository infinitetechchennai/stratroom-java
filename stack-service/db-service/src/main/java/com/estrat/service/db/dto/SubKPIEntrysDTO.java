...
public class SubKPIEntrysDTO {
    ...
    public SubKPIEntrysDTO() {
    }

    public SubKPIEntrysDTO(SubKPIEntrys subKPIEntrys) {
        this.id = subKPIEntrys.getId();
        this.subkpiId = subKPIEntrys.getSubkpiId();
        this.subkpiName = subKPIEntrys.getSubkpiName();
        this.selfRating = subKPIEntrys.getSelfRating();
        this.managerRating = subKPIEntrys.getManagerRating();
        this.consensualRating = subKPIEntrys.getConsensualRating();
        this.preferenceId = subKPIEntrys.getPreferenceId().getId();
    }
