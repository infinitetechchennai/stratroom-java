...
@Entity
@Table(name="risk_event_history", schema="orgstructure")
public class RiskEventHistory {
    @Id
    ...
    public RiskEventHistory() {
    }

    public RiskEventHistory(RiskEvent dto) throws JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        if (dto.getId() != null) {
            this.riskEventId = dto.getId();
        }
    ...
    public void setRiskEventId(long risEventId) {
        this.riskEventId = risEventId;
    }
    ...
    public String toString() {
        return "RiskEventHistory [id=" + this.id + ", riskEventId=" + this.riskEventId + ", incidentDate=" + this.incidentDate + ", riskCode=" + this.riskCode + ", incident=" + this.incident + ", eventType=" + this.eventType + ", incidentCategory=" + this.incidentCategory + ", incidentDescription=" + this.incidentDescription + ", impactCategory=" + this.impactCategory + ", impactDescription=" + this.impactDescription + ", impactLevel=" + this.impactLevel + ", correctiveAction=" + this.correctiveAction + ", riskMitigation=" + this.riskMitigation + ", eventStatus=" + this.eventStatus + ", reporter=" + this.reporter + ", reporterName=" + this.reporterName + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", createdBy=" + this.createdBy + ", updatedBy=" + this.updatedBy + ", pageId=" + this.pageId + ", departmentId=" + this.departmentId + ", incidentImpactData=" + this.incidentImpactData + ", version=" + this.version + ", status=" + this.status + ", changeId=" + this.changeId + "]";
    }
}
