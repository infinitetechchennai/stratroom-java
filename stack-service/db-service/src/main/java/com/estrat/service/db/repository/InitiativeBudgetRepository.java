...
extends JpaRepository<InitiativesBudget, Long> {
    ...
    public List<InitiativesBudget> findByInitiativeIdwDate(@Param(value="initiative") String var1, @Param(value="endDate") Date var2, @Param(value="orgId") Long var3);
    ...
    public List<InitiativesBudget> findByListInitiativeIdwDate(@Param(value="initiative") List<String> var1, @Param(value="endDate") List<Date> var2, @Param(value="orgId") Long var3);
