 ...
 *  com.estrat.service.db.resource.BudgetDetailController
...
import com.estrat.service.db.service.BudgetDetailService;
...
public class BudgetDetailController {
    ...
    public ResponseEntity<BudgetDTO> updateBudgetDetails(@RequestBody BudgetDTO budgetDTO, HttpServletRequest request) throws RequestException {
        ...
        if (!workflows.isEmpty()) {
            ...
            HashMap<String, BudgetDTO> maps = stagingdto.getNewValue();
            System.out.println("Before map :: " + maps);
            if (maps == null) {
                maps = new HashMap<String, BudgetDTO>();
            }
