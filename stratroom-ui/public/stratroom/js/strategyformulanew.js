...
var scoreCardIdValue;
var objectiveIdValue;
var kpiIdValue;
var subKpiIdValue;

console.log(scoreCardIdValue, "scoreCardIdValue");
    ...
    success: function (data) {
      $.each(data, function (forindex, fordata) {
        if (forindex == "Strategy Formulation") {
          ...
          if (
            fordata.Perspective.privilegeUpdate != undefined &&
            fordata.Perspective.privilegeUpdate == "TRUE"
          ) {
            perspectiveeditpermission = true;
          }
          if (
            fordata.Perspective.privilegeView != undefined &&
            fordata.Perspective.privilegeView == "TRUE"
          ) {
            perspectiveviewpermission = true;
          }
          //objective
          if (
            fordata.Objective.privilegeCreate != undefined &&
            fordata.Objective.privilegeCreate == "TRUE"
          ) {
            objectivecreatepermission = true;
          }
          if (
            fordata.Objective.privilegeUpdate != undefined &&
            fordata.Objective.privilegeUpdate == "TRUE"
          ) {
            objectiveeditpermission = true;
          }
          if (
            fordata.Objective.privilegeView != undefined &&
            fordata.Objective.privilegeView == "TRUE"
          ) {
            objectiveviewpermission = true;
          }
          if (
            fordata.Objective.privilegeDelete != undefined &&
            fordata.Objective.privilegeDelete == "TRUE"
          ) {
            objectivedeletepermission = true;
          }
          //kpi
          if (
            fordata.KPI.privilegeCreate != undefined &&
            fordata.KPI.privilegeCreate == "TRUE"
          ) {
            kpicreatepermission = true;
          }
          if (
            fordata.KPI.privilegeUpdate != undefined &&
            fordata.KPI.privilegeUpdate == "TRUE"
          ) {
            kpieditpermission = true;
          }
          if (
            fordata.KPI.privilegeView != undefined &&
            fordata.KPI.privilegeView == "TRUE"
          ) {
            kpiviewpermission = true;
          }
          if (
            fordata.KPI.privilegeDelete != undefined &&
            fordata.KPI.privilegeDelete == "TRUE"
          ) {
...
$(function () {
  ...
  if (
    strategyformodPermission.privilegeCreate != undefined &&
    strategyformodPermission.privilegeCreate == "TRUE"
  ) {
    createpermission = true;
  }

  if (
    strategyformodPermission.privilegeUpdate != undefined &&
    strategyformodPermission.privilegeUpdate == "TRUE"
  ) {
    editpermission = true;
  }

  if (
    strategyformodPermission.privilegeDelete != undefined &&
    strategyformodPermission.privilegeDelete == "TRUE"
  ) {
    deletepermission = true;
  }

  if (
    strategyformodPermission.privilegeView != undefined &&
    strategyformodPermission.privilegeView == "TRUE"
  ) {
    viewpermission = true;
  }
...
function formulationSuccessCallback(data) {
  ...
  var StartEndDate = "Start and End Date" 
  var planTypeHeader = "Plan Type"
  var approvedBy = "Approved By"
  var approveDateHeader = "Approved Date"

  if (storedLanguage == "en") {
    departmentHeader = "Department";
    StartEndDate = "Start and End Date";
    planTypeHeader = "Plan Type";
    approvedBy = "Approved By";
    approveDateHeader = "Approved Date";
} else if (storedLanguage == "am") {
    departmentHeader = "ዳርቻ / ክፍል";
    StartEndDate = "መጀመሪያ እና መጨረሻ ቀን";
    planTypeHeader = "የእቅፍ አይነት";
    approvedBy = "በማን ተፈቅዷል";
    approveDateHeader = "የፈቀደበት ቀን";
} else {
    // Arabic
    departmentHeader = "القسم";
    StartEndDate = "تاريخ البدء والانتهاء";
    planTypeHeader = "نوع الخطة";
    approvedBy = "تمت الموافقة بواسطة";
    approveDateHeader = "تاريخ الاعتماد";
}

  console.log(data, "sidebardatadata");
  ...
  if (viewpermission == true) {
    ...
    $.each(data, function (index, initiative) {
      ...
      var formulationDept =
        initiative.formulationDept != undefined
          ? initiative.formulationDept
          : "";
      ...
      if (riskimage == "" || riskimage == " " || riskimage == undefined) {
        var Owner =
          "data-name='" + username + "' class='rounded-circle riskuser'";
      } else {
        var Owner = " class='rounded-circle' src='" + riskimage + "' ";
      }

      var name = initiative.formulationName;
      var planType = initiative.planType;
      var approvedDate = initiative.approvedDate;
      var startDate = initiative.startDate;
      var full_name = name;
      ...
      var finalHtml = {
        ...
        initiativeSidebarHighLight:
          initiative_load_id == initiative.id ? "formulaSidebarHighLight" : "",
          departmentHeader : departmentHeader,
          approveDateHeader : approveDateHeader, 
      };
...
function subinitiatiesPorfileFormation(usersimg, defaultreporteelist, type) {
  var dataname =
    type == "strageyformulation" ? "approvedimage" : "initiativeviewuserimage";
  var subinitiativeUser = "";
  var profileBadgeIncrement =
    usersimg != undefined && usersimg != "" && usersimg.length >= 3
      ? parseInt(usersimg.length) - parseInt(2)
      : 0;
  if (usersimg != undefined && usersimg != "" && usersimg.length != 0) {
    $.each(usersimg, function (index, users) {
      ...
      if (usersimg.length >= 3 && index >= 2) {
        ...
        subinitiativeUser +=
          '<li class="avatar avatar-xs pull-up"><span _ngcontent-hhc-c5="" class="avatar-initial rounded-circle">+' +
...
function formulationdescSuccessCallback(result, initiative_load_id) {
  ...
  var StartEndDate = "Start and End Date" 
  var planTypeHeader = "Plan Type"
  var approvedByHeader = "Approved By"
  var viewHeader = "View"
  var deleteHeader  = "Delete"
  var formulationTeamHeader = "Formulation Team"
...
if (storedLanguage == "en") {
    ...
    deleteHeader = "Delete";
    viewHeader = "View";
    formulationTeamHeader = "Formulation Team";
} else if (storedLanguage == "am") {
    departmentHeader = "ዳርቻ / ክፍል";
    StartEndDate = "መጀመሪያ እና መጨረሻ ቀን";
    planTypeHeader = "የእቅፍ አይነት";
    approvedByHeader = "በማን ተፈቅዷል";
    deleteHeader = "ሰርዝ";
    viewHeader = "እይ";
    formulationTeamHeader = "የእቅፍ ቡድን";
} else {
    // Arabic
    departmentHeader = "القسم";
    StartEndDate = "تاريخ البدء والانتهاء";
    planTypeHeader = "نوع الخطة";
    approvedByHeader = "تمت الموافقة بواسطة";
    deleteHeader = "حذف";
    viewHeader = "عرض";
    formulationTeamHeader = "فريق الصياغة";
}
  ...
  if (
    formulationupdateDescription != "" &&
    formulationupdateDescription.status == "Approved"
  ) {
  ...
  var approvedBy =
    result.approvedBy == undefined || result.approvedBy == ""
      ? currentEmp
      : result.approvedBy;
  var approveduser = {};
  $.each(reporteelist, function (ownkey, empvalue) {
  ...
  var userProfileConcate =
    users.image == undefined || users.image == ""
      ? "data-name='" + username + "' class='rounded-circle approvedimage' "
      : " class='rounded-circle' src='" + users.image + "'";
  var approvedUserlogo =
    '<li class="avatar avatar-xs pull-up"><img ' +
    userProfileConcate +
    ' alt="' +
    username +
  ...
  if (deletepermission == true) {
    deleteicon =
      `<span class="pull-right"><i class="fas fa-trash border-box" data-toggle="tooltip"
                      data-placement="bottom"
                      title="Delete Formulation" onclick="openStrategyAdd(` +
      result.id +
      `,'delete')" style="padding: 5px"></i></span>`;
  }
  ...
  var initdetail = {
    ...
    planTypeHeader : planTypeHeader,
    approvedByHeader : approvedByHeader,
    StartEndDate : StartEndDate,
    departmentHeader : departmentHeader,
    viewHeader : viewHeader,
    deleteHeader : deleteHeader,
    formulationTeamHeader : formulationTeamHeader
  };

  $("#formulationTypeValue").val(result.id);
  $("#formulationIdValue").val(result.formulationName);

  $(".strategy-formula").html(template(initdetail));
  $(".approvedimage").initial({
    charCount: 2,
    height: 30,
    width: 30,
    fontSize: 18,
...
function perspectiveTemplateload(result) {
  ...
  $.each(result.scoreCardList, function (i, List) {
    ...
    var subInitdetail;
    // = Mustache.render(swotchildtemplate,
    // 	{
    // 		id:List.id,
    // 		parentid:result.id,
    // 		highlight:highlight,
  ...
  var htmlValue = `
<div class="card org-structure-card">
    <div class="card-body">
        <ul id="org-structure" class="nested-area org-nested-main">
            ${result.scoreCardList
              .map((scorecard) => {
                // Determine icon based on perspective type
                let iconSrc = "";
                switch (scorecard.perspectiveType) {
                  case "Financial":
                    iconSrc = "images/strategy-default-i.svg";
                    break;
                  case "Customer":
                    iconSrc = "images/strategy-default-i.svg";
                    break;
...
<li class="nested-item non-draggable">
            ...
            <div class="strategy-content">
                ...
                <div class="content">
                    <p class="strategy-label d-flex flex-column gap-1">
                        <strong>${scorecard.scoreCardValue.name || scorecard.scoreCardValue.perspectiveType}</strong>
                        <span class="text-muted">${result.formulationName || ""}</span>
                    </p>
                </div>
            </div>
                    ...
                    <li>
                        <a href="#add-objective" data-bs-toggle="modal">
                            <span class="icon" data-bs-toggle="tooltip"
                                data-bs-placement="bottom" data-bs-title="Add Objective" onclick="openObjectiveAdd('${scorecard.id}','add')">
                     ...
                     <li>
                                    <a href="#add-prespective" data-bs-toggle="modal">
                                        <span class="icon" data-bs-toggle="tooltip"
                                            data-bs-placement="bottom" data-bs-title="Edit Objective" onclick="openPerspectiveAdd('${scorecard.id}','edit')">
                                ...
                                <li>
                                    <a href="#delete-modal" data-bs-toggle="modal">
                                        <span class="icon" data-bs-toggle="tooltip"
                                            data-bs-placement="bottom" data-bs-title="Delete" onclick="openPrespectivedelete('${scorecard.id}')">
    ...
    ${scorecard.objectiveList && scorecard.objectiveList.length > 0 ? `
    <ul class="nested nested-area">
        ${scorecard.objectiveList.map((objective) => {
            return `
            <li class="nested-item non-draggable">
                <div class="caret"></div>
                <div class="card strategy-box parent">
                    <div class="strategy-section">
                        <div class="strategy-content">
                            <div class="icon">
                                <img src="images/target-i.svg" width="16" height="16">
                            </div>
                            <div class="content">
                                <p class="strategy-label"><strong>${objective.objectivesValue.name}</strong></p>
                                ${objective.objectivesValue.description ? `<p class="text-muted">${objective.objectivesValue.description}</p>` : ""}
                            </div>
                        </div>
                        <div class="strategy-action">
                            <ul class="list-unstyled action-list">
                                <li>
                                    <a href="#add-kpi" data-bs-toggle="modal" onclick="openKPIAdd('${objective.id}','add')">
                                        <span class="icon" data-bs-toggle="tooltip"
                                            data-bs-placement="bottom" data-bs-title="Add KPI">
                                            <i class="fas fa-plus title_edit_icon"></i>
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#add-objective" data-bs-toggle="modal">
                                        <span class="icon" data-bs-toggle="tooltip"
                                            data-bs-placement="bottom" data-bs-title="Edit Objective" onclick="openObjectiveAdd('${objective.id}','edit')">
                                            <img src="images/edit-i.svg" width="8" height="8" />
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#delete-modal" data-bs-toggle="modal">
                                        <span class="icon" data-bs-toggle="tooltip"
                                            data-bs-placement="bottom" data-bs-title="Delete" onclick="openObjectivedelete('${objective.id}')">
                                            <img src="images/delete-i.svg" width="12" height="12" />
                                        </span>
                                    </a>
                                </li>
                ...
                ${objective.kpiList && objective.kpiList.length > 0 ? `
                <ul class="nested nested-area">
                        ...
                        <li class="nested-item non-draggable">
                            ...
                            <div class="card strategy-box parent">
                                <div class="strategy-section">
                                    <div class="strategy-content">
                                        <div class="icon">
                                            <img src="images/kpi-i.svg" width="16" height="16">
                                        </div>
                                        <div class="content">
                                            <div class="d-flex flex-column gap-1">
                                                <p class="strategy-label"><strong>${kpi.kpiValue.name}</strong> - ${kpi.kpiValue.kpi_measurement}</p>
                                                <p class="strategy-label"><strong>Target</strong> - ${kpi.kpiValue.target}</p>
                                                ${kpi.kpiValue.description ? `<p class="text-muted">${kpi.kpiValue.description}</p>` : ""}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="strategy-action">
                                        <ul class="list-unstyled action-list">
                                            <li>
                                                <a href="#add-sub-kpi" data-bs-toggle="modal" onclick="openSubKpiAdd('${objective.id}', '${kpi.id}', '', 'add')">
                                                    <span class="icon" data-bs-toggle="tooltip"
                                            ...
                                            <li>
                                                <a href="#add-kpi" data-bs-toggle="modal" onclick="openKPIAdd('${kpi.id}','edit')">
                                                    <span class="icon" data-bs-toggle="tooltip"
                                                        data-bs-placement="bottom" data-bs-title="Edit KPI">
                                                        <img src="images/edit-i.svg" width="8" height="8" />
                                                    </span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#delete-modal" data-bs-toggle="modal">
                                                    <span class="icon" data-bs-toggle="tooltip"
                                                        data-bs-placement="bottom"
                                                        data-bs-title="Delete" onclick="openKPIdelete('${kpi.id}')">
                                                        <img src="images/delete-i.svg" width="12" height="12" />
                                                    </span>
                                                </a>
                                            </li>
                            ...
                            ${kpi.subKpiList && kpi.subKpiList.length > 0 ? `
                            <ul class="nested nested-area">
                                    ...
                                    <li class="nested-item non-draggable">
                                        <div class="card strategy-box parent">
                                            <div class="strategy-section">
                                                <div class="strategy-content">
                                                    <div class="icon">
                                                        <img src="images/subkpi-i.svg" width="16" height="16">
                                                    </div>
                                                    <div class="content">
                                                        <div class="d-flex flex-column gap-1">
                                                            <p class="strategy-label"><strong>${subKpi.subkpiValue.name}</strong> - ${subKpi.subkpiValue.kpi_measurement}</p>
                                                            <p class="strategy-label"><strong>Target</strong> - ${subKpi.subkpiValue.target}</p>
                                                            ${subKpi.subkpiValue.description ? `<p class="text-muted">${subKpi.subkpiValue.description}</p>` : ""}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="strategy-action">
                                                    <ul class="list-unstyled action-list">
                                                        <li>
                                                            <a href="#add-sub-kpi" data-bs-toggle="modal" onclick="openSubKpiAdd('${objective.id}', '${kpi.id}', '${subKpi.id}', 'edit')">
                                                                <span class="icon" data-bs-toggle="tooltip"
                                                                    data-bs-placement="bottom"
                                                        ...
                                                        <li>
                                                            <a href="#delete-modal" data-bs-toggle="modal">
                                                                <span class="icon" data-bs-toggle="tooltip"
                                                                    data-bs-placement="bottom"
                                                                    data-bs-title="Delete" onclick="openSubKPIdelete('${subKpi.id}')">
                                                                    <img src="images/delete-i.svg" width="12" height="12" />
                                                                </span>
                                                            </a>
                                                        </li>
...
`;
  ...
  // = 	Mustache.render(swoteParenttemplate, {
  // 	bodyRows : bodyRows
  // });
...
function objectiveTemplateload(result) {
  ...
  $.each(result.scoreCardList, function (scorecardindex, scorecarddata) {
    if (
      getinitiativePagenumber != undefined &&
      getinitiativePagenumber != "" &&
      scorecarddata.id == getinitiativePagenumber
    ) {
      var objectivepageid = "";
      var checkobjectiveIsavailableornot = false;
      var getobjectivePagenumber = localStorage.getItem("objective_pagenumber");
      if (
        getobjectivePagenumber != undefined &&
        getobjectivePagenumber != "" &&
        getobjectivePagenumber != null
      ) {
        objectivepageid = getobjectivePagenumber;
      }

      if (
        scorecarddata.objectiveList.some(
          (person) => person.id == objectivepageid
        )
      ) {
...
function kpiTemplateload(result) {
  ...
  objectivePagenumber =
    objectivePagenumber != undefined && objectivePagenumber != ""
      ? objectivePagenumber
      : 0;
  $.each(result.scoreCardList, function (scorecardindex, scorecarddata) {
    if (
      scorecardPagenumber != undefined &&
      scorecardPagenumber != "" &&
      scorecarddata.id == scorecardPagenumber
    ) {
      $.each(scorecarddata.objectiveList, function (i, List) {
        if (
          objectivePagenumber != undefined &&
          objectivePagenumber != "" &&
          List.id == objectivePagenumber
        ) {
          var kpipageid = "";
          var checkkpiIsavailableornot = false;
          var getkpiPagenumber = localStorage.getItem("kpilist_pagenumber");
          if (
            getkpiPagenumber != undefined &&
            getkpiPagenumber != "" &&
            getkpiPagenumber != null
          ) {
          ...
          $.each(List.kpiList, function (kpi, kpiList) {
            ...
            if (image == "" || image == " ") {
              var Owner =
                "data-name='" + username + "' class='rounded-circle kpiuser'";
            } else {
...
function openStrategyAdd(id, action) {
  ...
  if(action == "add"){
    $("#formulationHeader").html("Add Strategy Formulation");
  }else if(action == "edit"){
    $("#formulationHeader").html("Edit Strategy Formulation");
  }
  console.log(id, action, "actionDataData");
  formvalidationerrorreset();
  $(".sidebar-strategy").hide();
  $("#searchactivities_new").val("");
...
if( action == "card"){
 $.ajax({
        ...
        success: function (data) {
          ...
          localStorage.setItem("objective_pagenumber", "");
          formulationupdateDescription = data;
          console.log(data, id, "Ganeshhhhh");
    ...
    $('#stragey_formulation_Form input[type="checkbox"]').removeAttr(
      "disabled"
    );
    $("#stragey_formulation_Form select").removeAttr("disabled");
    $("#strategy_add").modal("show");
    $("#formulationsave").show();
    $("#approve_str,#reset_str").hide();
    $(".formulationheader").html(
      'Add Formulation Details <span class="pull-right" onclick="closeStrategyAdd()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span>'
    );
    ...
    // $('#stragey_formulation_Form input[type="checkbox"]').attr(
    //   "disabled",
    //   true
    // );
    ...
    $(".formulationheader").html(
      'Strategy Formulation Details <span class="pull-right" onclick="closeStrategyAdd()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span>'
    );
    if (action == "edit") {
      $("#approve_str").hide();
      if (editpermission == true) {
        // $(".formulationheader").html(
        //   'Strategy Formulation Details <span class="pull-right" onclick="closeStrategyAdd()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span><span class="pull-right" id="edit_strategy" style="margin-right: 12px" ><i class="fas fa-pencil-alt border-box"></i></span>'
        // );

        // $("#formulationHeader").html("Strategy Formulation Details");
        $("#approve_str").show();
      }
      $("#stragey_formulation_Form input[name='id']").val(id);
      localStorage.setItem("formulation_pagenumber", id);
      $(".sub_initiative_sidebar_details").removeClass(
        "formulaSidebarHighLight"
      );
...
function formulationEditSuccessCallback(data, id) {
  ...
  if (data.status == "Approved") {
    ...
    $('#stragey_formulation_Form input[type="checkbox"]').prop(
      "disabled",
      true
    );
  ...
  var resultPorfileContent = subinitiativePorfileContent(
    data.employeeList,
    id,
    "edit",
    "formulation"
...
//   console.log(id, action, method, "idactionmethod");
//   $("#searchactivities_new").val("");
...
//   var data = {};
//   if (action == "edit") {
//     $("#sub-ini-box_view_users_new").html("");
//     $("#sub-ini-box_view_users_new").html(
...
//         });
//         $("#sub-ini-box_view_users_new").html("");
//         $("#sub-ini-box_view_users_new").html(subinitiativeUser);
    ...
    $.ajax({
      ...
      success: function (result, status) {
        ...
        $.each(result, function (index, users) {
          ...
          var checkboxId = "attendees_" + users.id;
        ...
        subinitiativeUser +=     '<input ';
        subinitiativeUser +=       'class="form-check-input getselectedActivitiesUsers" ';
        subinitiativeUser +=       'type="checkbox" ';
        subinitiativeUser +=       'name="activities_owner[]" ';
        subinitiativeUser +=       'id="' + checkboxId + '" ';
        subinitiativeUser +=       'value="' + users.id + '" ';
        subinitiativeUser +=       'data-formulationid="' + id + '" ';
        subinitiativeUser +=       ischecked + ' ';
        subinitiativeUser +=     '>';
        subinitiativeUser +=     '<label class="form-check-label" for="' + checkboxId + '">';
        subinitiativeUser +=       '<span class="image">';
       subinitiativeUser +=          '<img alt="' + username +'" ' + userProfileConcate +'>';
        subinitiativeUser +=       '</span>';
        subinitiativeUser +=       '<span class="name">' + username + '</span>';
...
function getformulationObj(action) {
  ...
  formulationTeam =
    formulationTeam == "" || formulationTeam == undefined
      ? currentEmp
      : formulationTeam;
...
$("#stragey_formulation_Form").validate({
  submitHandler: function(form, event) {  
    handleformulationSave(event);  
    return false;  
  }
});

function handleformulationSave(event) {
...
function subinitiativePorfileContent(usersimg, resultId, method, type) {
  ...
  if (type == "approvedby") {
    userseslectedData = [];
    userseslectedData.push(
      $("#stragey_formulation_Form #approvedbyemployee").val()
    );
    var approveduser = {};
    $.each(reporteelist, function (ownkey, empvalue) {
      if (
        empvalue.id == $("#stragey_formulation_Form #approvedbyemployee").val()
      ) {
        approveduser = {
          id: empvalue.id,
          name: empvalue.name,
...
$(document).on("click", "input[name='activities_owner[]']", function () {
  if ($("#user_edit_popup .approvedemplist").length) {
    $("#user_edit_popup input[name='activities_owner[]']:checked").each(
      function (index) {
...
$(document).on("click", ".getselectedActivitiesUsers", function () {
  ...
  var selectedSubinitiativeOwner = $(
    "#user_edit_popup input[name='activities_owner[]']:checked"
  ).each(function (index) {
...
function openPerspectiveAdd(id, action) {
  if(action == "edit") {
    $(".perspectiveHeader").html("Edit Perspective"); 
  } else {
    $(".perspectiveHeader").html("Add Perspective");
  }
  ...
  if (
    formulationupdateDescription.startDate != undefined &&
    formulationupdateDescription.startDate != "" &&
    formulationupdateDescription.endDate != undefined &&
    formulationupdateDescription.endDate != ""
  ) {
  ...
  if (action == "add") {
    ...
    $(".perspectiveheader").html(
      'Add Perspective <span class="pull-right" onclick="closePerspectiveAdd()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span>'
    );
    ...
    if (editpermission == false) {
      $(".perspectiveheader").html(
        'Perspective Details <span class="pull-right" onclick="closePerspective()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span>'
      );
    }
    if (editpermission == true) {
      $(".perspectiveheader").html(
        'Perspective Details <span class="pull-right" onclick="closePerspective()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span><span class="pull-right" id="edit_perspective" style="margin-right: 12px" ><i class="fas fa-pencil-alt border-box"></i></span>'
      );
    }
    ...
    if (action == "edit") {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $("#perspectiveIdValue").val(data.id);
          $("#formulationIdValue").val(data.formulationId);
          $("#formulationNameValue").val(data.perspectiveType);
          $("#formulationDescription").val(data.scoreCardValue.formulationDescription);
          $("#formulationWeight").val(data.scoreCardValue.formulationWeight);
          $("#formulationSubWeight").val(data.scoreCardValue.formulationSubWeight);
          $("#formulationStartDate").val(data.scoreCardValue.formulationStartDate);
          $("#formulationEndDate").val(data.scoreCardValue.formulationEndDate);
          $("#formulationStatus").val(data.scoreCardValue.formulationStatus);
...
function perspectiveEditSuccessCallback(data, id) {
  ...
  if (
    data.scoreCardValue.weight != "" &&
    data.scoreCardValue.weight != undefined
  ) {
  ...
  if (
    data.scoreCardValue.perspective_start_end_date != "" &&
    data.scoreCardValue.perspective_start_end_date != undefined
  ) {
    $("#perspective_start_end_date").val(
      data.scoreCardValue.perspective_start_end_date
    );
...
function getperspectiveObj(action) {
  perspectiveupdateDescription["scoreCardValue"]["name"] =
    $("#perspective_name").val();
  perspectiveupdateDescription["owner"] = $("#perspective_owner").val();
  perspectiveupdateDescription["scoreCardValue"]["status"] = $(
    "#perspective_status"
  ).val();
  perspectiveupdateDescription["scoreCardValue"]["weight"] = $(
    "#perspective_weight"
  ).val();
  perspectiveupdateDescription["scoreCardValue"]["subweight"] = $(
    "#perspective_sub_weight"
  ).val();
  perspectiveupdateDescription["scoreCardValue"]["perspective_start_end_date"] =
    $("#perspective_start_end_date").val();
  ...
  if (validatedate != undefined && validatedate.includes("-")) {
    if (startdate != "" && enddate != "") {
      ...
      if (
        ...
        $.notify(
          "Failed: Start and end date should be between this formulation",
          {
            style: "error",
...
function openKPIdelete(id) {
  if (
    ...
    $("#objective_add").hide();
    $.notify(
      "Error: This is approved formulation so you will not able to add",
      {
        style: "error",
        className: "graynotify",
      }
...
function openSubKPIdelete(id) {
   $("#deletescoreid").val(id);
   $("#deleteModalscorecard").modal("toggle");
   $("#deleterecordtype").val("subKpi");
}


function openPrespectivedelete(id) {
  console.log(id, "objectiveId");
  
  $("#deleteperspectiveid").val(id);
 
  $("#deletePerspective").modal("toggle");
  
}

function openObjectivedelete(id) {
  console.log(id, "objectiveId");
...
function openObjectiveAdd(id, action) {
  ...
  if (action == "add") {
    ...
    $(".objectiveheader").html(
      'Add Objective <span class="pull-right" onclick="closeObjectiveAdd()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span>'
    );
    var resultPorfileContent = subinitiativePorfileContent([], 0, "new");
    $("#formulationteamid").val(resultPorfileContent["userownerlist_data"]);
    $("#formulationTeam").html(resultPorfileContent["userownerlist"]);
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        console.log(data, "objective Description Data");

        $(".objectiveheader").html("Objective Details");
        ...
        if (
          data.objectivesValue.objective_start_end_date != "" &&
          data.objectivesValue.objective_start_end_date != undefined
        ) {
          $("#objective_start_end_date").val(
            data.objectivesValue.objective_start_end_date
          );
        ...
        if (
          data.objectivesValue.weight != "" &&
          data.objectivesValue.weight != undefined
        ) {
    ...
    if (editpermission == true) {
      $(".objectiveheader").html(
        'Objective Details <span class="pull-right" onclick="closeObjective()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span><span class="pull-right" id="edit_objective" style="margin-right: 12px" ><i class="fas fa-pencil-alt border-box"></i></span>'
      );
    }
    if (editpermission == false) {
      $(".objectiveheader").html(
        'Objective Details <span class="pull-right" onclick="closeObjective()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span>'
      );
    }
...
function getobjectiveObj(action) {
  if (action == "add") {
    ...
    objectiveupdateDescription["objectivesValue"]["name"] =
      $("#objective_name").val();
    objectiveupdateDescription["owner"] = $("#objective_owner").val();
    objectiveupdateDescription["objectivesName"] = $("#objective_name").val();
    objectiveupdateDescription["objectivesValue"]["status"] =
      $("#objective_status").val();
    objectiveupdateDescription["objectivesValue"]["weight"] =
      $("#objectiveweight").val();
    objectiveupdateDescription["objectivesValue"]["subweight"] = $(
      "#objective_sub_weight"
    ).val();
    objectiveupdateDescription["objectivesValue"]["objective_start_end_date"] =
      $("#objective_start_end_date").val();
...
function getKpiObj(action) {
  ...
  if (action == "add") {
    ...
    if (kpiupdateDescription["kpiFormula"] != undefined) {
      ...
      kpiupdateDescription["kpiFormula"]["fieldName"] =
        $("#kpiFieldName").val();
    }
    ...
    kpiupdateDescription["kpiValue"]["kpi_measurement"] =
      $("#kpi_measurement").val();
    kpiupdateDescription["kpiValue"]["kpi_datasource"] =
      $("#kpi_datasource").val();
    kpiupdateDescription["kpiValue"]["weight"] = $("#kpi_weight").val();
    kpiupdateDescription["kpiValue"]["kpi_start_end_date"] = $(
      "#kpi_start_end_date"
    ).val();
    ...
    kpiupdateDescription["kpiValue"]["kpiCurrency"] =
      $("#kpiCurrencyvalue").val();
...
function openSubKpiAdd(id, kpiId, subKpiId, action) {
  console.log(id, kpiId, subKpiId, action, "getData");
  console.log(id, kpiId, "objectiveid");
  var objectiveid = id;
  objectiveIdValue = id;
  kpiIdValue = kpiId;
  subKpiIdValue = subKpiId
   populateobjectiveOwnerDropdownScorecard("#subKpi_owner", "");
  if(action == "edit"){
  
     $.ajax({
        url: "/stratroom/subkpi/strategyFormulation/" + subKpiId,
        success: function (data) {
          console.log(data, "subKpiData");
        subKpiSuccessCallback(data)
        },
      });
  }else{
    ...
    $("#subkpi_name").val("");
    $("#subkpi_description").val("");
    $("#subkpi_start_end_date").val("");
    $("#subkpi_type").val("");
    $("#subkpi_measurement").val("");
    $("#subkpiDataType").val("");
    $("#subkpi_datasource").val("");
    $("#subkpi_weight").val("");
    $("#subkpi_sub_weight").val("");
    $("#subtargetamount").val("");
  }
...
function openKPIAdd(id, action) {
  ...
  if (action == "add") {
    ...
    $(".kpiheader").html(
      'Add KPI <span class="pull-right" onclick="closeKPIAdd()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span>'
    );
    ...
    if (editpermission == true) {
      $(".kpiheader").html(
        'KPI Details <span class="pull-right" onclick="closeKPIAdd()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span><span class="pull-right" id="edit_kpi" style="margin-right: 12px" ><i class="fas fa-pencil-alt border-box"></i></span>'
      );
    }
    if (editpermission == false) {
      $(".kpiheader").html(
        'KPI Details <span class="pull-right" onclick="closeKPIAdd()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span>'
      );
    }
...
function kpiSuccessCallback(kpiData) {
  ...
  if (
    kpiData.kpiValue.kpi_start_end_date != "" &&
...
function subKpiSuccessCallback(kpiData) {
  console.log(kpiData, kpiData?.subkpiValue.name,  "subkpiData");
  $("#subkpi_name").val(kpiData.subkpiValue.name);
  $("#subkpi_type").val(kpiData.subkpiValue.kpiType);
  var kpimeasurement =
    kpiData.subkpiValue.kpi_measurement != undefined &&
    kpiData.subkpiValue.kpi_measurement != ""
      ? sentenceCase(kpiData.subkpiValue.kpi_measurement)
      : "";
  $("#subkpi_measurement").val(kpimeasurement);
  if (kpiData.owner == "") {
    $("#subKpi_owner").val(currentEmp);
  } else {
    $("#subKpi_owner").val(kpiData.owner);
  }

  var kpidatasource =
    kpiData.subkpiValue.kpi_datasource != undefined &&
    kpiData.subkpiValue.kpi_datasource != ""
      ? sentenceCase(kpiData.subkpiValue.kpi_datasource)
      : "";

  $("#subkpi_datasource").val(kpidatasource); 
  
  $("#subkpiDataType").val(kpiData.subkpiValue.dataType);
  $("#subkpi_threshold").val(kpiData.subkpiValue.threshold);

  var numberchartTarget = splitnumbercharacter(kpiData.subkpiValue.target);
  ...
  var targetcurrency =
    kpiData.subkpiValue.targetCurrency != undefined &&
    kpiData.subkpiValue.targetCurrency != ""
      ? kpiData.subkpiValue.targetCurrency
      : "";
  kpiTarget =
    targetcurrency +
  ...
  $("#subtargetamount").val(kpiTarget);

  if (
    kpiData.subkpiValue.kpi_start_end_date != "" &&
    kpiData.subkpiValue.kpi_start_end_date != undefined
  ) {
    $("#subkpi_start_end_date").val(kpiData.subkpiValue.kpi_start_end_date);
  } else {
    $("#subkpi_start_end_date").val(
      formulationupdateDescription.startDate +
        " - " +
    ...
    $("#subkpi_weight").val(kpiData.subkpiValue.weight);
  

   var kpistatus =
    kpiData.subkpiValue.status != undefined && kpiData.subkpiValue.status != ""
      ? sentenceCase(kpiData.subkpiValue.status)
      : "";

  $("#subkpi_sub_weight").val(kpiData.subkpiValue.subweight);
  $("#subkpi_status").val(kpistatus);

    if (kpiData["kpiFormula"] != undefined) {
    $("#formula_actual").val(kpiData.kpiFormula.formula);
    $("#kpiFieldName").val(kpiData.kpiFormula.fieldName);
    $("#subkpi_start_end_date").val(kpiData.kpiFormula.period);
  }



  // $("#subKpi_Form input[name='id']").val(kpiData.id);
  // var kpistatus =
  //   kpiData.subkpiValue.status != undefined && kpiData.subkpiValue.status != ""
  //     ? sentenceCase(kpiData.kpiValue.status)
  //     : "";
  ...
  // ) {
  //   $(".subkpiheader").html(
  //     'Sub KPI Details <span class="pull-right" onclick="closeKPIAdd()" style="font-size: 15px; cursor: pointer"><i class="fas fa-times border-box"></i></span>'
  //   );
  // }
  // if (kpiData.owner == "") {
  //   $("#subKpi_owner").val(currentEmp);
  ...
  //   $("#subkpi_start_end_date").val(kpiData.kpiFormula.period);
  // }
  // $("#subkpi_formula").val(kpiData.subkpiValue.actual);
  // $("#subkpiDataType").val(kpiData.subkpiValue.dataType);
  // if (kpiData.subkpiValue.dataType == "Currency") {
  //   $("#currency_input").show();
  // }
  // $("#kpiCurrencyvalue").val(kpiData.subkpiValue.kpiCurrency);
  // $("#subkpi_type").val(kpiData.subkpiValue.kpiType);
  // $("#subkpi_measurement").val(kpimeasurement);
  // if (
  //   kpiData.subkpiValue.kpi_start_end_date != "" &&
  ...
  // }
  // $("#subkpi_datasource").val(kpidatasource);
  // if (kpiData.subkpiValue.weight != "" && kpiData.subkpiValue.weight != undefined) {
  //   $("#subkpi_weight").val(kpiData.subkpiValue.weight);
  // } else {
  //   $("#subkpi_weight").val(0);
  // }
...
$(document).on("click", "#edit_strategy", function () {
  ...
  if ($("#approvedDate").val() == "") {
    ...
    $('#stragey_formulation_Form input[type="text"]')
      .not("#approvedDate")
      .removeAttr("disabled");
  }
  $("#stragey_formulation_Form select").removeAttr("disabled");
...
function addList(id, text, value) {
  ...
  $(id).append(
    `<li class="list-group-item" onclick="updateFormula(${value})">${text}</li>`
  );
}
...
function handleperspectivedelete() {
  var id = $("#deleteperspectiveid").val();
  $.ajax({
    url: "/stratroom/scorecard/strategyFormulation/" + id,
    type: "Delete",
    contentType: "application/json",
...
function handlescoreeventdelete() {
  ...
  if (type == "kpi") {
    ...
    url = "/stratroom/strategyFormulation/" + id;
     ...
     url = "/stratroom/subkpi/strategyFormulation/" + id;
  }
...
$("#activities_close_search2").click(function () {
  ...
  $("#activities_search2").show();
  $("#activities_search_section2").hide();
  var value = $("#searchactivities_new").val().toLowerCase();
  $("#sub-ini-box_view_users_new .employe_content_border h5").filter(function (e) {
...
$(document).ready(function () {
  $("#searchactivities_new").off("keyup").on("keyup", function () {
    var value = $(this).val().toLowerCase().trim();
    var $container = $("#sub-ini-box_view_users_new");
    var $items = $container.find(".list-group-item.attendee");
    var visibleCount = 0;

    $items.each(function () {
      var $item = $(this);
      var userName = $item.find(".name").text().toLowerCase();
...
$(document).on("click", "#allusersactivities", function () {
  ...
  if (propcheck == true) {
    $("#sub-ini-box_view_users_new input[name='activities_owner[]']").each(
...
function saveSubKpi() {
  //Payload to save sub KPI
  var subKpiData = {
    subkpiName: $("#subkpi_name").val() || "",
    owner: $("#subKpi_owner").val(),
    createdBy: currentEmp,
    kpiId: kpiIdValue,
    id: subKpiIdValue ? subKpiIdValue : "",
    objectiveId: objectiveIdValue,
    kpiFormula: {
      formula: null,
      elementName: null,
    ...
    subkpiValue: {
      ...
      targetCurrency: "",
      kpiCurrency: $("#subkpi_sub_weight").val(),
      kpiId: kpiIdValue,
      dataType: $("#subkpiDataType").val(),
      description: "",
      weight: $("#subkpi_weight").val(),
      threshold: $("#subkpi_threshold").val() || "",
      target: $("#subtargetamount").val(),
      kpi_datasource: $("#subkpi_datasource").val(),
      kpiType: $("#kpi_type").val(),
      name: $("#subkpi_name").val(),
      kpi_start_end_date: $("#subkpi_start_end_date").val(),
      status: $("#subkpi_status").val(),
    },
  };

  console.log(subKpiData, "subKpiData");
  $.ajax({
    url: "/stratroom/subkpi/strategyFormulation",
    type: "post",
    contentType: "application/json",
    data: JSON.stringify(subKpiData),
    success: function (data, status) {
      if (data.id != undefined && data.id != "") {
        localStorage.setItem("kpilist_pagenumber", data.id);
      }
...
function savePrespective(){
  const idValue = $('#formulationIdValue').val();
  const nameValue = $('#formulationTypeValue').val();

  console.log(idValue, nameValue, "value");

  const payload = {
    id: $("#perspectiveIdValue").val() || "",
    formulationId : $("#formulationIdValue").val() || "",
    scorecardName: idValue,
    perspectiveType: $("#formulationNameValue").val(),
    objectiveList : objectiveList || [],
    formulationId: nameValue,
    scoreCardValue:{
      formulationName: $("#formulationNameValue").val(),
      perspectiveType: $("#formulationNameValue").val(),
      formulationDescription: $("#formulationDescription").val(),
      formulationWeight: $("#formulationWeight").val(),
      formulationSubWeight: $("#formulationSubWeight").val(),
      formulationStartDate: $("#formulationStartDate").val(),
      formulationEndDate: $("#formulationEndDate").val(),
      formulationStatus: $("#formulationStatus").val(),
    }
  }
...
Handlebars.registerHelper('badgeClass', function(planType) {
  console.log(planType, 'planType');
  if (planType == 'Long Term') return 'bg-success';
  if (planType == 'Short Term') return 'bg-warning';
  if (planType == 'Medium Term') return 'bg-info';
  return 'bg-secondary'; // fallback
});



const page_strategyFormulation_en = {
  "Delete" : "Delete",
  ...
  "Formulation Team": "Formulation Team",
  ...
  "Cancel": "Cancel",
  "Save": "Save",
  "Add Strategic Plan": "Add Strategic Plan",
  "Add Formulation": "Add Formulation",
  "Plan Type": "Plan Type",
  "Short Term": "Short Term",
  "Medium Term": "Medium Term",
  "Long Term": "Long Term",
  "Import Formulation": "Import Formulation",
  ...
  "Target": "Target",
  "YTD": "YTD",
  "Add Sub-KPI": "Add Sub-KPI",
  "Formulation Register" : "Formulation Register"
}

const page_strategyFormulation_am = {
  "Delete": "ሰርዝ",
  "Strategy Formulation": "የስትራተጂ እቅፍ መዋቅር",
  "View": "እይ",
  "Import": "አስመጣ",
  "Export": "አውጣ",
  "Department": "ዳርቻ / ክፍል",
  "Start and End Date": "መጀመሪያ እና መጨረሻ ቀን",
  "Approved Date": "የፈቀደበት ቀን",
  "Formulation Team": "የእቅፍ ቡድን",
  "Approved By": "በማን ተፈቅዷል",
  "Add Perspective": "አስተያየት ጨምር",
  "Name": "ስም",
  "Description": "መግለጫ",
  "Weight (%)": "ክብደት (%)",
  "Sub Weight (%)": "ንዑስ ክብደት (%)",
  ...
  "Cancel": "ይቅር",
  "Save": "አስቀምጥ",
  "Add Strategic Plan": "የስትራተጂ እቅፍ ጨምር",
  "Add Formulation": "እቅፍ ጨምር",
  "Plan Type": "የእቅፍ አይነት",
  "Short Term": "አጭር ጊዜ",
  "Medium Term": "መካከለኛ ጊዜ",
  "Long Term": "ረጅም ጊዜ",
  "Import Formulation": "እቅፍ አስመጣ",
  "Add Objective": "ዕቅድ ጨምር",
  "Add KPI": "KPI ጨምር",
  "Polarity": "ኃይል / አቀማመጥ",
  "Measurement Frequency": "የመጠን ተደጋጋሚነት",
  "Data Source": "የውሂብ ምንጭ",
  "KPI Type": "የKPI አይነት",
  "Threshold": "ክልል",
  "Actual": "እውነተኛ",
  "Target": "ግብ",
  "YTD": "ዓመት እስከ አሁን",
  "Add Sub-KPI": "ንዑስ KPI ጨምር",
  "Formulation Register": "የእቅፍ ምዝገባ"
}



const page_strategyFormulation_ar = {
  "Delete" : "حذف",
  ...
  "Export": "تصدير",
  "Department": "القسم",
  "Start and End Date": "تاريخ البدء والانتهاء",
  "Approved Date": "تاريخ الاعتماد",
  "Formulation Team": "فريق الصياغة",
  "Approved By": "تمت الموافقة بواسطة",
  "Add Perspective": "إضافة منظور",
  "Name": "الاسم",
  "Description": "الوصف",
  "Weight (%)": "الوزن (%)",
  ...
  "Cancel": "إلغاء",
  "Save": "حفظ",
  "Add Strategic Plan": "إضافة خطة استراتيجية",
  "Add Formulation": "إضافة صياغة",
  "Plan Type": "نوع الخطة",
  "Short Term": "قصيرة المدى",
  "Medium Term": "متوسطة المدى",
  "Long Term": "طويلة المدى",
  "Import Formulation": "استيراد الصياغة",
  "Add Objective": "إضافة هدف",
  "Add KPI": "إضافة مؤشر أداء رئيسي",
  "Polarity": "الاتجاه",
  "Measurement Frequency": "تكرار القياس",
  ...
  "Target": "المستهدف",
  "YTD": "منذ بداية العام",
  "Add Sub-KPI": "إضافة مؤشر فرعي",
  "Formulation Register": "سجل الصياغة"
...
function loadLanguage(lang) {
  ...
  if (lang === 'ar') {
    translation = page_strategyFormulation_ar;
  } else if(lang == "am"){
    translation = page_strategyFormulation_am;
  }else {
    translation = page_strategyFormulation_en;
  }
