...
// ── styles ────────────────────────────────────────────────────────────────────
const S = {
    page: { fontFamily: "system-ui,sans-serif", background: "#f3e9fa", minHeight: "100%", paddingBottom: 40 },
...
export const KpiStoryCardModal = () => {
    ...
    return (
        <div className="modal fade" id="kpi-story-card-modal" tabIndex="-1" role="dialog" aria-hidden="true" style={{ zIndex: 1060 }}>
            <div className="modal-dialog modal-xl modal-dialog-scrollable" style={{ maxWidth: '95vw', marginTop: '2vh', marginBottom: '2vh' }}>
                <div className="modal-content" style={{ border: 'none', background: '#f3e9fa', borderRadius: 12, overflow: 'hidden' }}>
                    <div className="modal-header border-0 p-3 position-absolute w-100 d-flex justify-content-end" style={{ zIndex: 1100, pointerEvents: 'none' }}>
                        <button
                            type="button"
                            ...
                            data-dismiss="modal"
                            aria-label="Close"
                            style={{ backgroundColor: 'white', padding: 12, borderRadius: '50%', opacity: 1, pointerEvents: 'auto', boxShadow: '0 2px 5px rgba(0,0,0,0.2)' }}
                        >
                            <span aria-hidden="true" className="d-none">&times;</span>
                        </button>
                    </div>
                    <div className="modal-body p-0 position-relative" style={{ padding: 0 }}>
                        ...
                        <div style={S.page}>
                            ...
                            {showEditModal && (
                                <>
                                    <div className="modal show d-block" tabIndex="-1" role="dialog" style={{ backgroundColor: 'rgba(0,0,0,0.5)', zIndex: 1070 }}>
